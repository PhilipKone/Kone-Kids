...
const Mascot: React.FC = () => {
  ...
  return (
    <div 
      ...
      onMouseLeave={() => !showBubble && setIsWaving(false)}
    ...
    >
      ...
      <svg width="100%" viewBox="0 0 400 400" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ transition: 'transform 0.3s', maxWidth: '500px' }} className={isWaving ? '' : 'animate-float'}>
        <defs>
        ...
        <g filter="url(#soft-shadow)">
          ...
          {/* Smile - moved down to clear the eyes */}
