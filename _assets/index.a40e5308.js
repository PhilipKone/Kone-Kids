 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xb{constructor(e,t){this.position=e,this.inclusive=t}}function Rb(e,t,n){let r=0;for(let i=0;i<e.position.length;i++){const a=t[i],s=e.position[i];if(r=a.field.isKeyField()?uw.comparator(uw.fromName(s.referenceValue),n.key):pb(s,n.data.field(a.field)),"desc"===a.dir&&(r*=-1),0!==r)break}return r}function Pb(e,t){if(null===e)return null===t;if(null===t)return!1;if(e.inclusive!==t.inclusive||e.position.length!==t.position.length)return!1;for(let n=0;n<e.position.length;n++)if(!db(e.position[n],t.position[n]))return!1;return!0}
/**
 * @license
 * Copyright 2022 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Lb{}class Mb extends Lb{constructor(e,t,n){super(),this.field=e,this.op=t,this.value=n}static create(e,t,n){return e.isKeyField()?"in"===t||"not-in"===t?this.createKeyFieldInFilter(e,t,n):new qb(e,t,n):"array-contains"===t?new Kb(e,n):"in"===t?new Gb(e,n):"not-in"===t?new Qb(e,n):"array-contains-any"===t?new Yb(e,n):new Mb(e,t,n)}static createKeyFieldInFilter(e,t,n){return"in"===t?new Hb(e,n):new Wb(e,n)}matches(e){const t=e.data.field(this.field);return"!="===this.op?null!==t&&void 0===t.nullValue&&this.matchesComparison(pb(t,this.value)):null!==t&&hb(this.value)===hb(t)&&this.matchesComparison(pb(t,this.value))}matchesComparison(e){switch(this.op){case"<":return e<0;case"<=":return e<=0;case"==":return 0===e;case"!=":return 0!==e;case">":return e>0;case">=":return e>=0;default:return Mv(47266,{operator:this.op})}}isInequality(){return["<","<=",">",">=","!=","not-in"].indexOf(this.op)>=0}getFlattenedFilters(){return[this]}getFilters(){return[this]}}class Fb extends Lb{constructor(e,t){super(),this.filters=e,this.op=t,this.Pe=null}static create(e,t){return new Fb(e,t)}matches(e){return Ub(this)?void 0===this.filters.find(t=>!t.matches(e)):void 0!==this.filters.find(t=>t.matches(e))}getFlattenedFilters(){return null!==this.Pe||(this.Pe=this.filters.reduce((e,t)=>e.concat(t.getFlattenedFilters()),[])),this.Pe}getFilters(){return Object.assign([],this.filters)}}function Ub(e){return"and"===e.op}function Vb(e){return function(e){for(const t of e.filters)if(t instanceof Fb)return!1;return!0}(e)&&Ub(e)}function zb(e){if(e instanceof Mb)return e.field.canonicalString()+e.op.toString()+yb(e.value);if(Vb(e))return e.filters.map(e=>zb(e)).join(",");{const t=e.filters.map(e=>zb(e)).join(",");return`${e.op}(${t})`}}function jb(e,t){return e instanceof Mb?(n=e,(r=t)instanceof Mb&&n.op===r.op&&n.field.isEqual(r.field)&&db(n.value,r.value)):e instanceof Fb?function(e,t){return t instanceof Fb&&e.op===t.op&&e.filters.length===t.filters.length&&e.filters.reduce((e,n,r)=>e&&jb(n,t.filters[r]),!0)}(e,t):void Mv(19439);var n,r}function Bb(e){return e instanceof Mb?`${(t=e).field.canonicalString()} ${t.op} ${yb(t.value)}`:e instanceof Fb?function(e){return e.op.toString()+" {"+e.getFilters().map(Bb).join(" ,")+"}"}(e):"Filter";var t}class qb extends Mb{constructor(e,t,n){super(e,t,n),this.key=uw.fromName(n.referenceValue)}matches(e){const t=uw.comparator(e.key,this.key);return this.matchesComparison(t)}}class Hb extends Mb{constructor(e,t){super(e,"in",t),this.keys=$b("in",t)}matches(e){return this.keys.some(t=>t.isEqual(e.key))}}class Wb extends Mb{constructor(e,t){super(e,"not-in",t),this.keys=$b("not-in",t)}matches(e){return!this.keys.some(t=>t.isEqual(e.key))}}function $b(e,t){return(t.arrayValue?.values||[]).map(e=>uw.fromName(e.referenceValue))}class Kb extends Mb{constructor(e,t){super(e,"array-contains",t)}matches(e){const t=e.data.field(this.field);return _b(t)&&fb(t.arrayValue,this.value)}}class Gb extends Mb{constructor(e,t){super(e,"in",t)}matches(e){const t=e.data.field(this.field);return null!==t&&fb(this.value.arrayValue,t)}}class Qb extends Mb{constructor(e,t){super(e,"not-in",t)}matches(e){if(fb(this.value.arrayValue,{nullValue:"NULL_VALUE"}))return!1;const t=e.data.field(this.field);return null!==t&&void 0===t.nullValue&&!fb(this.value.arrayValue,t)}}class Yb extends Mb{constructor(e,t){super(e,"array-contains-any",t)}matches(e){const t=e.data.field(this.field);return!(!_b(t)||!t.arrayValue.values)&&t.arrayValue.values.some(e=>fb(this.value.arrayValue,e))}}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
function NE(e,t){if(e.useProto3Json){if(isNaN(t))return{doubleValue:"NaN"};if(t===1/0)return{doubleValue:"Infinity"};if(t===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:Pw(t)?"-0":t}}function xE(e){return{integerValue:""+e}}function RE(e,t){return function(e){return"number"==typeof e&&Number.isInteger(e)&&!Pw(e)&&e<=Number.MAX_SAFE_INTEGER&&e>=Number.MIN_SAFE_INTEGER}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class PE{constructor(){this._=void 0}}function DE(e,t,n){return e instanceof ME?function(e,t){const n={fields:{[Jw]:{stringValue:Yw},[Zw]:{timestampValue:{seconds:e.seconds,nanos:e.nanoseconds}}}};return t&&eb(t)&&(t=tb(t)),t&&(n.fields[Xw]=t),{mapValue:n}}(n,t):e instanceof FE?UE(e,t):e instanceof VE?zE(e,t):function(e,t){const n=LE(e,t),r=BE(n)+BE(e.Ae);return Eb(n)&&Eb(e.Ae)?xE(r):NE(e.serializer,r)}(e,t)}function OE(e,t,n){return e instanceof FE?UE(e,t):e instanceof VE?zE(e,t):n}function LE(e,t){return e instanceof jE?Eb(n=t)||(r=n)&&"doubleValue"in r?t:{integerValue:0}:null;var n,r}class ME extends PE{}class FE extends PE{constructor(e){super(),this.elements=e}}function UE(e,t){const n=qE(t);for(const t of e.elements)n.some(e=>db(e,t))||n.push(t);return{arrayValue:{values:n}}}class VE extends PE{constructor(e){super(),this.elements=e}}function zE(e,t){let n=qE(t);for(const t of e.elements)n=n.filter(e=>!db(e,t));return{arrayValue:{values:n}}}class jE extends PE{constructor(e,t){super(),this.serializer=e,this.Ae=t}}function BE(e){return Gw(e.integerValue||e.doubleValue)}function qE(e){return _b(e)&&e.arrayValue.values?e.arrayValue.values.slice():[]}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class HE{constructor(e,t){this.field=e,this.transform=t}}class WE{constructor(e,t){this.version=e,this.transformResults=t}}class $E{constructor(e,t){this.updateTime=e,this.exists=t}static none(){return new $E}static exists(e){return new $E(void 0,e)}static updateTime(e){return new $E(e)}get isNone(){return void 0===this.updateTime&&void 0===this.exists}isEqual(e){return this.exists===e.exists&&(this.updateTime?!!e.updateTime&&this.updateTime.isEqual(e.updateTime):!e.updateTime)}}function KE(e,t){return void 0!==e.updateTime?t.isFoundDocument()&&t.version.isEqual(e.updateTime):void 0===e.exists||e.exists===t.isFoundDocument()}class GE{}function QE(e,t){if(!e.hasLocalMutations||t&&0===t.fields.length)return null;if(null===t)return e.isNoDocument()?new a_(e.key,$E.none()):new e_(e.key,e.data,$E.none());{const n=e.data,r=Cb.empty();let i=new jw(cw.comparator);for(let e of t.fields)if(!i.has(e)){let t=n.field(e);null===t&&e.length>1&&(e=e.popLast(),t=n.field(e)),null===t?r.delete(e):r.set(e,t),i=i.add(e)}return new t_(e.key,r,new qw(i.toArray()),$E.none())}}function YE(e,t,n){var r;e instanceof e_?function(e,t,n){const r=e.value.clone(),i=r_(e.fieldTransforms,t,n.transformResults);r.setAll(i),t.convertToFoundDocument(n.version,r).setHasCommittedMutations()}(e,t,n):e instanceof t_?function(e,t,n){if(!KE(e.precondition,t))return void t.convertToUnknownDocument(n.version);const r=r_(e.fieldTransforms,t,n.transformResults),i=t.data;i.setAll(n_(e)),i.setAll(r),t.convertToFoundDocument(n.version,i).setHasCommittedMutations()}(e,t,n):(r=n,t.convertToNoDocument(r.version).setHasCommittedMutations())}function JE(e,t,n,r){return e instanceof e_?function(e,t,n,r){if(!KE(e.precondition,t))return n;const i=e.value.clone(),a=i_(e.fieldTransforms,r,t);return i.setAll(a),t.convertToFoundDocument(t.version,i).setHasLocalMutations(),null}(e,t,n,r):e instanceof t_?function(e,t,n,r){if(!KE(e.precondition,t))return n;const i=i_(e.fieldTransforms,r,t),a=t.data;return a.setAll(n_(e)),a.setAll(i),t.convertToFoundDocument(t.version,a).setHasLocalMutations(),null===n?null:n.unionWith(e.fieldMask.fields).unionWith(e.fieldTransforms.map(e=>e.field))}(e,t,n,r):(i=t,a=n,KE(e.precondition,i)?(i.convertToNoDocument(i.version).setHasLocalMutations(),null):a);var i,a}function XE(e,t){let n=null;for(const r of e.fieldTransforms){const e=t.data.field(r.field),i=LE(r.transform,e||null);null!=i&&(null===n&&(n=Cb.empty()),n.set(r.field,i))}return n||null}function ZE(e,t){return e.type===t.type&&!!e.key.isEqual(t.key)&&!!e.precondition.isEqual(t.precondition)&&(n=e.fieldTransforms,r=t.fieldTransforms,!!(void 0===n&&void 0===r||n&&r&&iw(n,r,(e,t)=>function(e,t){return e.field.isEqual(t.field)&&(n=e.transform,r=t.transform,n instanceof FE&&r instanceof FE||n instanceof VE&&r instanceof VE?iw(n.elements,r.elements,db):n instanceof jE&&r instanceof jE?db(n.Ae,r.Ae):n instanceof ME&&r instanceof ME);var n,r}(e,t)))&&(0===e.type?e.value.isEqual(t.value):1!==e.type||e.data.isEqual(t.data)&&e.fieldMask.isEqual(t.fieldMask)));var n,r}class e_ extends GE{constructor(e,t,n,r=[]){super(),this.key=e,this.value=t,this.precondition=n,this.fieldTransforms=r,this.type=0}getFieldMask(){return null}}class t_ extends GE{constructor(e,t,n,r,i=[]){super(),this.key=e,this.data=t,this.fieldMask=n,this.precondition=r,this.fieldTransforms=i,this.type=1}getFieldMask(){return this.fieldMask}}function n_(e){const t=new Map;return e.fieldMask.fields.forEach(n=>{if(!n.isEmpty()){const r=e.data.field(n);t.set(n,r)}}),t}function r_(e,t,n){const r=new Map;Uv(e.length===n.length,32656,{Ve:n.length,de:e.length});for(let i=0;i<n.length;i++){const a=e[i],s=a.transform,o=t.data.field(a.field);r.set(a.field,OE(s,o,n[i]))}return r}function i_(e,t,n){const r=new Map;for(const i of e){const e=i.transform,a=n.data.field(i.field);r.set(i.field,DE(e,a,t))}return r}class a_ extends GE{constructor(e,t){super(),this.key=e,this.precondition=t,this.type=2,this.fieldTransforms=[]}getFieldMask(){return null}}class s_ extends GE{constructor(e,t){super(),this.key=e,this.precondition=t,this.type=3,this.fieldTransforms=[]}getFieldMask(){return null}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class o_{constructor(e,t,n,r){this.batchId=e,this.localWriteTime=t,this.baseMutations=n,this.mutations=r}applyToRemoteDocument(e,t){const n=t.mutationResults;for(let t=0;t<this.mutations.length;t++){const r=this.mutations[t];r.key.isEqual(e.key)&&YE(r,e,n[t])}}applyToLocalView(e,t){for(const n of this.baseMutations)n.key.isEqual(e.key)&&(t=JE(n,e,t,this.localWriteTime));for(const n of this.mutations)n.key.isEqual(e.key)&&(t=JE(n,e,t,this.localWriteTime));return t}applyToLocalDocumentSet(e,t){const n=kE();return this.mutations.forEach(r=>{const i=e.get(r.key),a=i.overlayedDocument;let s=this.applyToLocalView(a,i.mutatedFields);s=t.has(r.key)?null:s;const o=QE(a,s);null!==o&&n.set(r.key,o),a.isValidDocument()||a.convertToNoDocument(_w.min())}),n}keys(){return this.mutations.reduce((e,t)=>e.add(t.key),CE())}isEqual(e){return this.batchId===e.batchId&&iw(this.mutations,e.mutations,(e,t)=>ZE(e,t))&&iw(this.baseMutations,e.baseMutations,(e,t)=>ZE(e,t))}}class l_{constructor(e,t,n,r){this.batch=e,this.commitVersion=t,this.mutationResults=n,this.docVersions=r}static from(e,t,n){Uv(e.mutations.length===n.length,58842,{me:e.mutations.length,fe:n.length});let r=TE;const i=e.mutations;for(let e=0;e<i.length;e++)r=r.insert(i[e].key,n[e].version);return new l_(e,t,n,r)}}
/**
 * @license
 * Copyright 2022 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class c_{constructor(e,t){this.largestBatchId=e,this.mutation=t}getKey(){return this.mutation.key}isEqual(e){return null!==e&&this.mutation===e.mutation}toString(){return`Overlay{\n      largestBatchId: ${this.largestBatchId},\n      mutation: ${this.mutation.toString()}\n    }`}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var h_,d_;function f_(e){if(void 0===e)return Dv("GRPC error has no .code"),zv.UNKNOWN;switch(e){case h_.OK:return zv.OK;case h_.CANCELLED:return zv.CANCELLED;case h_.UNKNOWN:return zv.UNKNOWN;case h_.DEADLINE_EXCEEDED:return zv.DEADLINE_EXCEEDED;case h_.RESOURCE_EXHAUSTED:return zv.RESOURCE_EXHAUSTED;case h_.INTERNAL:return zv.INTERNAL;case h_.UNAVAILABLE:return zv.UNAVAILABLE;case h_.UNAUTHENTICATED:return zv.UNAUTHENTICATED;case h_.INVALID_ARGUMENT:return zv.INVALID_ARGUMENT;case h_.NOT_FOUND:return zv.NOT_FOUND;case h_.ALREADY_EXISTS:return zv.ALREADY_EXISTS;case h_.PERMISSION_DENIED:return zv.PERMISSION_DENIED;case h_.FAILED_PRECONDITION:return zv.FAILED_PRECONDITION;case h_.ABORTED:return zv.ABORTED;case h_.OUT_OF_RANGE:return zv.OUT_OF_RANGE;case h_.UNIMPLEMENTED:return zv.UNIMPLEMENTED;case h_.DATA_LOSS:return zv.DATA_LOSS;default:return Mv(39323,{code:e})}}(d_=h_||(h_={}))[d_.OK=0]="OK",d_[d_.CANCELLED=1]="CANCELLED",d_[d_.UNKNOWN=2]="UNKNOWN",d_[d_.INVALID_ARGUMENT=3]="INVALID_ARGUMENT",d_[d_.DEADLINE_EXCEEDED=4]="DEADLINE_EXCEEDED",d_[d_.NOT_FOUND=5]="NOT_FOUND",d_[d_.ALREADY_EXISTS=6]="ALREADY_EXISTS",d_[d_.PERMISSION_DENIED=7]="PERMISSION_DENIED",d_[d_.UNAUTHENTICATED=16]="UNAUTHENTICATED",d_[d_.RESOURCE_EXHAUSTED=8]="RESOURCE_EXHAUSTED",d_[d_.FAILED_PRECONDITION=9]="FAILED_PRECONDITION",d_[d_.ABORTED=10]="ABORTED",d_[d_.OUT_OF_RANGE=11]="OUT_OF_RANGE",d_[d_.UNIMPLEMENTED=12]="UNIMPLEMENTED",d_[d_.INTERNAL=13]="INTERNAL",d_[d_.UNAVAILABLE=14]="UNAVAILABLE",d_[d_.DATA_LOSS=15]="DATA_LOSS";
/**
 * @license
 * Copyright 2022 Google LLC
 *
 ...
 * limitations under the License.
 */
const p_=new gv([4294967295,4294967295],0);function m_(e){const t=(new TextEncoder).encode(e),n=new yv;return n.update(t),new Uint8Array(n.digest())}function g_(e){const t=new DataView(e.buffer),n=t.getUint32(0,!0),r=t.getUint32(4,!0),i=t.getUint32(8,!0),a=t.getUint32(12,!0);return[new gv([n,r],0),new gv([i,a],0)]}class y_{constructor(e,t,n){if(this.bitmap=e,this.padding=t,this.hashCount=n,t<0||t>=8)throw new v_(`Invalid padding: ${t}`);if(n<0)throw new v_(`Invalid hash count: ${n}`);if(e.length>0&&0===this.hashCount)throw new v_(`Invalid hash count: ${n}`);if(0===e.length&&0!==t)throw new v_(`Invalid padding when bitmap length is 0: ${t}`);this.ge=8*e.length-t,this.pe=gv.fromNumber(this.ge)}ye(e,t,n){let r=e.add(t.multiply(gv.fromNumber(n)));return 1===r.compare(p_)&&(r=new gv([r.getBits(0),r.getBits(1)],0)),r.modulo(this.pe).toNumber()}we(e){return!!(this.bitmap[Math.floor(e/8)]&1<<e%8)}mightContain(e){if(0===this.ge)return!1;const t=m_(e),[n,r]=g_(t);for(let e=0;e<this.hashCount;e++){const t=this.ye(n,r,e);if(!this.we(t))return!1}return!0}static create(e,t,n){const r=e%8==0?0:8-e%8,i=new Uint8Array(Math.ceil(e/8)),a=new y_(i,r,t);return n.forEach(e=>a.insert(e)),a}insert(e){if(0===this.ge)return;const t=m_(e),[n,r]=g_(t);for(let e=0;e<this.hashCount;e++){const t=this.ye(n,r,e);this.Se(t)}}Se(e){const t=Math.floor(e/8),n=e%8;this.bitmap[t]|=1<<n}}class v_ extends Error{constructor(){super(...arguments),this.name="BloomFilterError"}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class w_{constructor(e,t,n,r,i){this.snapshotVersion=e,this.targetChanges=t,this.targetMismatches=n,this.documentUpdates=r,this.resolvedLimboDocuments=i}static createSynthesizedRemoteEventForCurrentChange(e,t,n){const r=new Map;return r.set(e,b_.createSynthesizedTargetChangeForCurrentChange(e,t,n)),new w_(_w.min(),r,new Uw(Zv),vE(),CE())}}class b_{constructor(e,t,n,r,i){this.resumeToken=e,this.current=t,this.addedDocuments=n,this.modifiedDocuments=r,this.removedDocuments=i}static createSynthesizedTargetChangeForCurrentChange(e,t,n){return new b_(n,t,CE(),CE(),CE())}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class E_{constructor(e,t,n,r){this.be=e,this.removedTargetIds=t,this.key=n,this.De=r}}class __{constructor(e,t){this.targetId=e,this.Ce=t}}class k_{constructor(e,t,n=Ww.EMPTY_BYTE_STRING,r=null){this.state=e,this.targetIds=t,this.resumeToken=n,this.cause=r}}class I_{constructor(){this.ve=0,this.Fe=C_(),this.Me=Ww.EMPTY_BYTE_STRING,this.xe=!1,this.Oe=!0}get current(){return this.xe}get resumeToken(){return this.Me}get Ne(){return 0!==this.ve}get Be(){return this.Oe}Le(e){e.approximateByteSize()>0&&(this.Oe=!0,this.Me=e)}ke(){let e=CE(),t=CE(),n=CE();return this.Fe.forEach((r,i)=>{switch(i){case 0:e=e.add(r);break;case 2:t=t.add(r);break;case 1:n=n.add(r);break;default:Mv(38017,{changeType:i})}}),new b_(this.Me,this.xe,e,t,n)}qe(){this.Oe=!1,this.Fe=C_()}Ke(e,t){this.Oe=!0,this.Fe=this.Fe.insert(e,t)}Ue(e){this.Oe=!0,this.Fe=this.Fe.remove(e)}$e(){this.ve+=1}We(){this.ve-=1,Uv(this.ve>=0,3241,{ve:this.ve})}Qe(){this.Oe=!0,this.xe=!0}}class T_{constructor(e){this.Ge=e,this.ze=new Map,this.je=vE(),this.Je=S_(),this.He=S_(),this.Ze=new Uw(Zv)}Xe(e){for(const t of e.be)e.De&&e.De.isFoundDocument()?this.Ye(t,e.De):this.et(t,e.key,e.De);for(const t of e.removedTargetIds)this.et(t,e.key,e.De)}tt(e){this.forEachTarget(e,t=>{const n=this.nt(t);switch(e.state){case 0:this.rt(t)&&n.Le(e.resumeToken);break;case 1:n.We(),n.Ne||n.qe(),n.Le(e.resumeToken);break;case 2:n.We(),n.Ne||this.removeTarget(t);break;case 3:this.rt(t)&&(n.Qe(),n.Le(e.resumeToken));break;case 4:this.rt(t)&&(this.it(t),n.Le(e.resumeToken));break;default:Mv(56790,{state:e.state})}})}forEachTarget(e,t){e.targetIds.length>0?e.targetIds.forEach(t):this.ze.forEach((e,n)=>{this.rt(n)&&t(n)})}st(e){const t=e.targetId,n=e.Ce.count,r=this.ot(t);if(r){const i=r.target;if(tE(i))if(0===n){const e=new uw(i.path);this.et(t,e,Nb.newNoDocument(e,_w.min()))}else Uv(1===n,20013,{expectedCount:n});else{const r=this._t(t);if(r!==n){const n=this.ut(e),i=n?this.ct(n,e,r):1;if(0!==i){this.it(t);const e=2===i?"TargetPurposeExistenceFilterMismatchBloom":"TargetPurposeExistenceFilterMismatch";this.Ze=this.Ze.insert(t,e)}}}}}ut(e){const t=e.Ce.unchangedNames;if(!t||!t.bits)return null;const{bits:{bitmap:n="",padding:r=0},hashCount:i=0}=t;let a,s;try{a=Qw(n).toUint8Array()}catch(e){if(e instanceof Hw)return Ov("Decoding the base64 bloom filter in existence filter failed ("+e.message+"); ignoring the bloom filter and falling back to full re-query."),null;throw e}try{s=new y_(a,r,i)}catch(e){return Ov(e instanceof v_?"BloomFilter error: ":"Applying bloom filter failed: ",e),null}return 0===s.ge?null:s}ct(e,t,n){return t.Ce.count===n-this.Pt(e,t.targetId)?0:2}Pt(e,t){const n=this.Ge.getRemoteKeysForTarget(t);let r=0;return n.forEach(n=>{const i=this.Ge.ht(),a=`projects/${i.projectId}/databases/${i.database}/documents/${n.path.canonicalString()}`;e.mightContain(a)||(this.et(t,n,null),r++)}),r}Tt(e){const t=new Map;this.ze.forEach((n,r)=>{const i=this.ot(r);if(i){if(n.current&&tE(i.target)){const t=new uw(i.target.path);this.Et(t).has(r)||this.It(r,t)||this.et(r,t,Nb.newNoDocument(t,e))}n.Be&&(t.set(r,n.ke()),n.qe())}});let n=CE();this.He.forEach((e,t)=>{let r=!0;t.forEachWhile(e=>{const t=this.ot(e);return!t||"TargetPurposeLimboResolution"===t.purpose||(r=!1,!1)}),r&&(n=n.add(e))}),this.je.forEach((t,n)=>n.setReadTime(e));const r=new w_(e,t,this.Ze,this.je,n);return this.je=vE(),this.Je=S_(),this.He=S_(),this.Ze=new Uw(Zv),r}Ye(e,t){if(!this.rt(e))return;const n=this.It(e,t.key)?2:0;this.nt(e).Ke(t.key,n),this.je=this.je.insert(t.key,t),this.Je=this.Je.insert(t.key,this.Et(t.key).add(e)),this.He=this.He.insert(t.key,this.Rt(t.key).add(e))}et(e,t,n){if(!this.rt(e))return;const r=this.nt(e);this.It(e,t)?r.Ke(t,1):r.Ue(t),this.He=this.He.insert(t,this.Rt(t).delete(e)),this.He=this.He.insert(t,this.Rt(t).add(e)),n&&(this.je=this.je.insert(t,n))}removeTarget(e){this.ze.delete(e)}_t(e){const t=this.nt(e).ke();return this.Ge.getRemoteKeysForTarget(e).size+t.addedDocuments.size-t.removedDocuments.size}$e(e){this.nt(e).$e()}nt(e){let t=this.ze.get(e);return t||(t=new I_,this.ze.set(e,t)),t}Rt(e){let t=this.He.get(e);return t||(t=new jw(Zv),this.He=this.He.insert(e,t)),t}Et(e){let t=this.Je.get(e);return t||(t=new jw(Zv),this.Je=this.Je.insert(e,t)),t}rt(e){const t=null!==this.ot(e);return t||Pv("WatchChangeAggregator","Detected inactive target",e),t}ot(e){const t=this.ze.get(e);return t&&t.Ne?null:this.Ge.At(e)}it(e){this.ze.set(e,new I_),this.Ge.getRemoteKeysForTarget(e).forEach(t=>{this.et(e,t,null)})}It(e,t){return this.Ge.getRemoteKeysForTarget(e).has(t)}}function S_(){return new Uw(uw.comparator)}function C_(){return new Uw(uw.comparator)}const A_={asc:"ASCENDING",desc:"DESCENDING"},N_={"<":"LESS_THAN","<=":"LESS_THAN_OR_EQUAL",">":"GREATER_THAN",">=":"GREATER_THAN_OR_EQUAL","==":"EQUAL","!=":"NOT_EQUAL","array-contains":"ARRAY_CONTAINS",in:"IN","not-in":"NOT_IN","array-contains-any":"ARRAY_CONTAINS_ANY"},x_={and:"AND",or:"OR"};class R_{constructor(e,t){this.databaseId=e,this.useProto3Json=t}}function P_(e,t){return e.useProto3Json||Rw(t)?t:{value:t}}function D_(e,t){return e.useProto3Json?`${new Date(1e3*t.seconds).toISOString().replace(/\.\d*/,"").replace("Z","")}.${("000000000"+t.nanoseconds).slice(-9)}Z`:{seconds:""+t.seconds,nanos:t.nanoseconds}}function O_(e,t){return e.useProto3Json?t.toBase64():t.toUint8Array()}function L_(e,t){return D_(e,t.toTimestamp())}function M_(e){return Uv(!!e,49232),_w.fromTimestamp(function(e){const t=Kw(e);return new Ew(t.seconds,t.nanos)}(e))}function F_(e,t){return U_(e,t).canonicalString()}function U_(e,t){const n=(r=e,new ow(["projects",r.projectId,"databases",r.database])).child("documents");var r;return void 0===t?n:n.child(t)}function V_(e){const t=ow.fromString(e);return Uv(rk(t),10190,{key:t.toString()}),t}function z_(e,t){return F_(e.databaseId,t.path)}function j_(e,t){const n=V_(t);if(n.get(1)!==e.databaseId.projectId)throw new jv(zv.INVALID_ARGUMENT,"Tried to deserialize key from different project: "+n.get(1)+" vs "+e.databaseId.projectId);if(n.get(3)!==e.databaseId.database)throw new jv(zv.INVALID_ARGUMENT,"Tried to deserialize key from different database: "+n.get(3)+" vs "+e.databaseId.database);return new uw(H_(n))}function B_(e,t){return F_(e.databaseId,t)}function q_(e){return new ow(["projects",e.databaseId.projectId,"databases",e.databaseId.database]).canonicalString()}function H_(e){return Uv(e.length>4&&"documents"===e.get(4),29091,{key:e.toString()}),e.popFirst(5)}function W_(e,t,n){return{name:z_(e,t),fields:n.value.mapValue.fields}}function $_(e,t){return{documents:[B_(e,t.path)]}}function K_(e,t){const n={structuredQuery:{}},r=t.path;let i;null!==t.collectionGroup?(i=r,n.structuredQuery.from=[{collectionId:t.collectionGroup,allDescendants:!0}]):(i=r.popLast(),n.structuredQuery.from=[{collectionId:r.lastSegment()}]),n.parent=B_(e,i);const a=function(e){if(0!==e.length)return tk(Fb.create(e,"and"))}(t.filters);a&&(n.structuredQuery.where=a);const s=function(e){if(0!==e.length)return e.map(e=>{return{field:Z_((t=e).field),direction:Y_(t.dir)};var t})}(t.orderBy);s&&(n.structuredQuery.orderBy=s);const o=P_(e,t.limit);return null!==o&&(n.structuredQuery.limit=o),t.startAt&&(n.structuredQuery.startAt={before:(l=t.startAt).inclusive,values:l.position}),t.endAt&&(n.structuredQuery.endAt=function(e){return{before:!e.inclusive,values:e.position}}(t.endAt)),{ft:n,parent:i};var l}function G_(e){let t=function(e){const t=V_(e);return 4===t.length?ow.emptyPath():H_(t)}(e.parent);const n=e.structuredQuery,r=n.from?n.from.length:0;let i=null;if(r>0){Uv(1===r,65062);const e=n.from[0];e.allDescendants?i=e.collectionId:t=t.child(e.collectionId)}let a=[];n.where&&(a=function(e){const t=Q_(e);return t instanceof Fb&&Vb(t)?t.getFilters():[t]}(n.where));let s=[];n.orderBy&&(s=n.orderBy.map(e=>{return new Db(ek((t=e).field),function(e){switch(e){case"ASCENDING":return"asc";case"DESCENDING":return"desc";default:return}}(t.direction));var t}));let o=null;n.limit&&(o=function(e){let t;return t="object"==typeof e?e.value:e,Rw(t)?null:t}(n.limit));let l=null;n.startAt&&(l=function(e){const t=!!e.before,n=e.values||[];return new xb(n,t)}(n.startAt));let c=null;return n.endAt&&(c=function(e){const t=!e.before,n=e.values||[];return new xb(n,t)}(n.endAt)),function(e,t,n,r,i,a,s,o){return new nE(e,t,n,r,i,a,s,o)}(t,i,s,a,o,"F",l,c)}function Q_(e){return void 0!==e.unaryFilter?function(e){switch(e.unaryFilter.op){case"IS_NAN":const t=ek(e.unaryFilter.field);return Mb.create(t,"==",{doubleValue:NaN});case"IS_NULL":const n=ek(e.unaryFilter.field);return Mb.create(n,"==",{nullValue:"NULL_VALUE"});case"IS_NOT_NAN":const r=ek(e.unaryFilter.field);return Mb.create(r,"!=",{doubleValue:NaN});case"IS_NOT_NULL":const i=ek(e.unaryFilter.field);return Mb.create(i,"!=",{nullValue:"NULL_VALUE"});case"OPERATOR_UNSPECIFIED":return Mv(61313);default:return Mv(60726)}}(e):void 0!==e.fieldFilter?(t=e,Mb.create(ek(t.fieldFilter.field),function(e){switch(e){case"EQUAL":return"==";case"NOT_EQUAL":return"!=";case"GREATER_THAN":return">";case"GREATER_THAN_OR_EQUAL":return">=";case"LESS_THAN":return"<";case"LESS_THAN_OR_EQUAL":return"<=";case"ARRAY_CONTAINS":return"array-contains";case"IN":return"in";case"NOT_IN":return"not-in";case"ARRAY_CONTAINS_ANY":return"array-contains-any";case"OPERATOR_UNSPECIFIED":return Mv(58110);default:return Mv(50506)}}(t.fieldFilter.op),t.fieldFilter.value)):void 0!==e.compositeFilter?function(e){return Fb.create(e.compositeFilter.filters.map(e=>Q_(e)),function(e){switch(e){case"AND":return"and";case"OR":return"or";default:return Mv(1026)}}(e.compositeFilter.op))}(e):Mv(30097,{filter:e});var t}function Y_(e){return A_[e]}function J_(e){return N_[e]}function X_(e){return x_[e]}function Z_(e){return{fieldPath:e.canonicalString()}}function ek(e){return cw.fromServerFormat(e.fieldPath)}function tk(e){return e instanceof Mb?function(e){if("=="===e.op){if(Ib(e.value))return{unaryFilter:{field:Z_(e.field),op:"IS_NAN"}};if(kb(e.value))return{unaryFilter:{field:Z_(e.field),op:"IS_NULL"}}}else if("!="===e.op){if(Ib(e.value))return{unaryFilter:{field:Z_(e.field),op:"IS_NOT_NAN"}};if(kb(e.value))return{unaryFilter:{field:Z_(e.field),op:"IS_NOT_NULL"}}}return{fieldFilter:{field:Z_(e.field),op:J_(e.op),value:e.value}}}(e):e instanceof Fb?function(e){const t=e.getFilters().map(e=>tk(e));return 1===t.length?t[0]:{compositeFilter:{op:X_(e.op),filters:t}}}(e):Mv(54877,{filter:e})}function nk(e){const t=[];return e.fields.forEach(e=>t.push(e.canonicalString())),{fieldPaths:t}}function rk(e){return e.length>=4&&"projects"===e.get(0)&&"databases"===e.get(2)}function ik(e){return!!e&&"function"==typeof e._toProto&&"ProtoValue"===e._protoValueType}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sk{constructor(e){this.yt=e}}function ok(e){const t=G_({parent:e.parent,structuredQuery:e.structuredQuery});return"LAST"===e.limitType?cE(t,t.limit,"L"):t}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class lk{constructor(){this.bn=new ck}addToCollectionParentIndex(e,t){return this.bn.add(t),Aw.resolve()}getCollectionParents(e,t){return Aw.resolve(this.bn.getEntries(t))}addFieldIndex(e,t){return Aw.resolve()}deleteFieldIndex(e,t){return Aw.resolve()}deleteAllFieldIndexes(e){return Aw.resolve()}createTargetIndexes(e,t){return Aw.resolve()}getDocumentsMatchingTarget(e,t){return Aw.resolve(null)}getIndexType(e,t){return Aw.resolve(0)}getFieldIndexes(e,t){return Aw.resolve([])}getNextCollectionGroupToUpdate(e){return Aw.resolve(null)}getMinOffset(e,t){return Aw.resolve(Iw.min())}getMinOffsetFromCollectionGroup(e,t){return Aw.resolve(Iw.min())}updateCollectionGroup(e,t,n){return Aw.resolve()}updateIndexEntries(e,t){return Aw.resolve()}}class ck{constructor(){this.index={}}add(e){const t=e.lastSegment(),n=e.popLast(),r=this.index[t]||new jw(ow.comparator),i=!r.has(n);return this.index[t]=r.add(n),i}has(e){const t=e.lastSegment(),n=e.popLast(),r=this.index[t];return r&&r.has(n)}getEntries(e){return(this.index[e]||new jw(ow.comparator)).toArray()}}
/**
 * @license
 * Copyright 2018 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const uk={didRun:!1,sequenceNumbersCollected:0,targetsRemoved:0,documentsRemoved:0},hk=41943040;class dk{static withCacheSize(e){return new dk(e,dk.DEFAULT_COLLECTION_PERCENTILE,dk.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT)}constructor(e,t,n){this.cacheSizeCollectionThreshold=e,this.percentileToCollect=t,this.maximumSequenceNumbersToCollect=n}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */dk.DEFAULT_COLLECTION_PERCENTILE=10,dk.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT=1e3,dk.DEFAULT=new dk(hk,dk.DEFAULT_COLLECTION_PERCENTILE,dk.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT),dk.DISABLED=new dk(-1,0,0);
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class fk{constructor(e){this.sr=e}next(){return this.sr+=2,this.sr}static _r(){return new fk(0)}static ar(){return new fk(-1)}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const pk="LruGarbageCollector";function mk([e,t],[n,r]){const i=Zv(e,n);return 0===i?Zv(t,r):i}class gk{constructor(e){this.Pr=e,this.buffer=new jw(mk),this.Tr=0}Er(){return++this.Tr}Ir(e){const t=[e,this.Er()];if(this.buffer.size<this.Pr)this.buffer=this.buffer.add(t);else{const e=this.buffer.last();mk(t,e)<0&&(this.buffer=this.buffer.delete(e).add(t))}}get maxValue(){return this.buffer.last()[0]}}class yk{constructor(e,t,n){this.garbageCollector=e,this.asyncQueue=t,this.localStore=n,this.Rr=null}start(){-1!==this.garbageCollector.params.cacheSizeCollectionThreshold&&this.Ar(6e4)}stop(){this.Rr&&(this.Rr.cancel(),this.Rr=null)}get started(){return null!==this.Rr}Ar(e){Pv(pk,`Garbage collection scheduled in ${e}ms`),this.Rr=this.asyncQueue.enqueueAfterDelay("lru_garbage_collection",e,async()=>{this.Rr=null;try{await this.localStore.collectGarbage(this.garbageCollector)}catch(e){Nw(e)?Pv(pk,"Ignoring IndexedDB error during garbage collection: ",e):await Cw(e)}await this.Ar(3e5)})}}class vk{constructor(e,t){this.Vr=e,this.params=t}calculateTargetCount(e,t){return this.Vr.dr(e).next(e=>Math.floor(t/100*e))}nthSequenceNumber(e,t){if(0===t)return Aw.resolve(xw.ce);const n=new gk(t);return this.Vr.forEachTarget(e,e=>n.Ir(e.sequenceNumber)).next(()=>this.Vr.mr(e,e=>n.Ir(e))).next(()=>n.maxValue)}removeTargets(e,t,n){return this.Vr.removeTargets(e,t,n)}removeOrphanedDocuments(e,t){return this.Vr.removeOrphanedDocuments(e,t)}collect(e,t){return-1===this.params.cacheSizeCollectionThreshold?(Pv("LruGarbageCollector","Garbage collection skipped; disabled"),Aw.resolve(uk)):this.getCacheSize(e).next(n=>n<this.params.cacheSizeCollectionThreshold?(Pv("LruGarbageCollector",`Garbage collection skipped; Cache size ${n} is lower than threshold ${this.params.cacheSizeCollectionThreshold}`),uk):this.gr(e,t))}getCacheSize(e){return this.Vr.getCacheSize(e)}gr(e,t){let n,r,i,a,s,o,l;const c=Date.now();return this.calculateTargetCount(e,this.params.percentileToCollect).next(t=>(t>this.params.maximumSequenceNumbersToCollect?(Pv("LruGarbageCollector",`Capping sequence numbers to collect down to the maximum of ${this.params.maximumSequenceNumbersToCollect} from ${t}`),r=this.params.maximumSequenceNumbersToCollect):r=t,a=Date.now(),this.nthSequenceNumber(e,r))).next(r=>(n=r,s=Date.now(),this.removeTargets(e,n,t))).next(t=>(i=t,o=Date.now(),this.removeOrphanedDocuments(e,n))).next(e=>(l=Date.now(),Rv()<=Th.DEBUG&&Pv("LruGarbageCollector",`LRU Garbage Collection\n\tCounted targets in ${a-c}ms\n\tDetermined least recently used ${r} in `+(s-a)+`ms\n\tRemoved ${i} targets in `+(o-s)+`ms\n\tRemoved ${e} documents in `+(l-o)+`ms\nTotal Duration: ${l-c}ms`),Aw.resolve({didRun:!0,sequenceNumbersCollected:r,targetsRemoved:i,documentsRemoved:e})))}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class wk{constructor(){this.changes=new gE(e=>e.toString(),(e,t)=>e.isEqual(t)),this.changesApplied=!1}addEntry(e){this.assertNotApplied(),this.changes.set(e.key,e)}removeEntry(e,t){this.assertNotApplied(),this.changes.set(e,Nb.newInvalidDocument(e).setReadTime(t))}getEntry(e,t){this.assertNotApplied();const n=this.changes.get(t);return void 0!==n?Aw.resolve(n):this.getFromCache(e,t)}getEntries(e,t){return this.getAllFromCache(e,t)}apply(e){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(e)}assertNotApplied(){}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _k{constructor(e){this.serializer=e,this.Nr=new Map,this.Br=new Map}getBundleMetadata(e,t){return Aw.resolve(this.Nr.get(t))}saveBundleMetadata(e,t){return this.Nr.set(t.id,{id:(n=t).id,version:n.version,createTime:M_(n.createTime)}),Aw.resolve();var n}getNamedQuery(e,t){return Aw.resolve(this.Br.get(t))}saveNamedQuery(e,t){return this.Br.set(t.name,{name:(n=t).name,query:ok(n.bundledQuery),readTime:M_(n.readTime)}),Aw.resolve();var n}}
/**
 * @license
 * Copyright 2022 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class kk{constructor(){this.overlays=new Uw(uw.comparator),this.Lr=new Map}getOverlay(e,t){return Aw.resolve(this.overlays.get(t))}getOverlays(e,t){const n=_E();return Aw.forEach(t,t=>this.getOverlay(e,t).next(e=>{null!==e&&n.set(t,e)})).next(()=>n)}saveOverlays(e,t,n){return n.forEach((n,r)=>{this.St(e,t,r)}),Aw.resolve()}removeOverlaysForBatchId(e,t,n){const r=this.Lr.get(n);return void 0!==r&&(r.forEach(e=>this.overlays=this.overlays.remove(e)),this.Lr.delete(n)),Aw.resolve()}getOverlaysForCollection(e,t,n){const r=_E(),i=t.length+1,a=new uw(t.child("")),s=this.overlays.getIteratorFrom(a);for(;s.hasNext();){const e=s.getNext().value,a=e.getKey();if(!t.isPrefixOf(a.path))break;a.path.length===i&&e.largestBatchId>n&&r.set(e.getKey(),e)}return Aw.resolve(r)}getOverlaysForCollectionGroup(e,t,n,r){let i=new Uw((e,t)=>e-t);const a=this.overlays.getIterator();for(;a.hasNext();){const e=a.getNext().value;if(e.getKey().getCollectionGroup()===t&&e.largestBatchId>n){let t=i.get(e.largestBatchId);null===t&&(t=_E(),i=i.insert(e.largestBatchId,t)),t.set(e.getKey(),e)}}const s=_E(),o=i.getIterator();for(;o.hasNext()&&(o.getNext().value.forEach((e,t)=>s.set(e,t)),!(s.size()>=r)););return Aw.resolve(s)}St(e,t,n){const r=this.overlays.get(n.key);if(null!==r){const e=this.Lr.get(r.largestBatchId).delete(n.key);this.Lr.set(r.largestBatchId,e)}this.overlays=this.overlays.insert(n.key,new c_(t,n));let i=this.Lr.get(t);void 0===i&&(i=CE(),this.Lr.set(t,i)),this.Lr.set(t,i.add(n.key))}}
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ik{constructor(){this.sessionToken=Ww.EMPTY_BYTE_STRING}getSessionToken(e){return Aw.resolve(this.sessionToken)}setSessionToken(e,t){return this.sessionToken=t,Aw.resolve()}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Tk{constructor(){this.kr=new jw(Sk.qr),this.Kr=new jw(Sk.Ur)}isEmpty(){return this.kr.isEmpty()}addReference(e,t){const n=new Sk(e,t);this.kr=this.kr.add(n),this.Kr=this.Kr.add(n)}$r(e,t){e.forEach(e=>this.addReference(e,t))}removeReference(e,t){this.Wr(new Sk(e,t))}Qr(e,t){e.forEach(e=>this.removeReference(e,t))}Gr(e){const t=new uw(new ow([])),n=new Sk(t,e),r=new Sk(t,e+1),i=[];return this.Kr.forEachInRange([n,r],e=>{this.Wr(e),i.push(e.key)}),i}zr(){this.kr.forEach(e=>this.Wr(e))}Wr(e){this.kr=this.kr.delete(e),this.Kr=this.Kr.delete(e)}jr(e){const t=new uw(new ow([])),n=new Sk(t,e),r=new Sk(t,e+1);let i=CE();return this.Kr.forEachInRange([n,r],e=>{i=i.add(e.key)}),i}containsKey(e){const t=new Sk(e,0),n=this.kr.firstAfterOrEqual(t);return null!==n&&e.isEqual(n.key)}}class Sk{constructor(e,t){this.key=e,this.Jr=t}static qr(e,t){return uw.comparator(e.key,t.key)||Zv(e.Jr,t.Jr)}static Ur(e,t){return Zv(e.Jr,t.Jr)||uw.comparator(e.key,t.key)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ck{constructor(e,t){this.indexManager=e,this.referenceDelegate=t,this.mutationQueue=[],this.Yn=1,this.Hr=new jw(Sk.qr)}checkEmpty(e){return Aw.resolve(0===this.mutationQueue.length)}addMutationBatch(e,t,n,r){const i=this.Yn;this.Yn++,this.mutationQueue.length>0&&this.mutationQueue[this.mutationQueue.length-1];const a=new o_(i,t,n,r);this.mutationQueue.push(a);for(const t of r)this.Hr=this.Hr.add(new Sk(t.key,i)),this.indexManager.addToCollectionParentIndex(e,t.key.path.popLast());return Aw.resolve(a)}lookupMutationBatch(e,t){return Aw.resolve(this.Zr(t))}getNextMutationBatchAfterBatchId(e,t){const n=t+1,r=this.Xr(n),i=r<0?0:r;return Aw.resolve(this.mutationQueue.length>i?this.mutationQueue[i]:null)}getHighestUnacknowledgedBatchId(){return Aw.resolve(0===this.mutationQueue.length?-1:this.Yn-1)}getAllMutationBatches(e){return Aw.resolve(this.mutationQueue.slice())}getAllMutationBatchesAffectingDocumentKey(e,t){const n=new Sk(t,0),r=new Sk(t,Number.POSITIVE_INFINITY),i=[];return this.Hr.forEachInRange([n,r],e=>{const t=this.Zr(e.Jr);i.push(t)}),Aw.resolve(i)}getAllMutationBatchesAffectingDocumentKeys(e,t){let n=new jw(Zv);return t.forEach(e=>{const t=new Sk(e,0),r=new Sk(e,Number.POSITIVE_INFINITY);this.Hr.forEachInRange([t,r],e=>{n=n.add(e.Jr)})}),Aw.resolve(this.Yr(n))}getAllMutationBatchesAffectingQuery(e,t){const n=t.path,r=n.length+1;let i=n;uw.isDocumentKey(i)||(i=i.child(""));const a=new Sk(new uw(i),0);let s=new jw(Zv);return this.Hr.forEachWhile(e=>{const t=e.key.path;return!!n.isPrefixOf(t)&&(t.length===r&&(s=s.add(e.Jr)),!0)},a),Aw.resolve(this.Yr(s))}Yr(e){const t=[];return e.forEach(e=>{const n=this.Zr(e);null!==n&&t.push(n)}),t}removeMutationBatch(e,t){Uv(0===this.ei(t.batchId,"removed"),55003),this.mutationQueue.shift();let n=this.Hr;return Aw.forEach(t.mutations,r=>{const i=new Sk(r.key,t.batchId);return n=n.delete(i),this.referenceDelegate.markPotentiallyOrphaned(e,r.key)}).next(()=>{this.Hr=n})}nr(e){}containsKey(e,t){const n=new Sk(t,0),r=this.Hr.firstAfterOrEqual(n);return Aw.resolve(t.isEqual(r&&r.key))}performConsistencyCheck(e){return this.mutationQueue.length,Aw.resolve()}ei(e,t){return this.Xr(e)}Xr(e){return 0===this.mutationQueue.length?0:e-this.mutationQueue[0].batchId}Zr(e){const t=this.Xr(e);return t<0||t>=this.mutationQueue.length?null:this.mutationQueue[t]}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ak{constructor(e){this.ti=e,this.docs=new Uw(uw.comparator),this.size=0}setIndexManager(e){this.indexManager=e}addEntry(e,t){const n=t.key,r=this.docs.get(n),i=r?r.size:0,a=this.ti(t);return this.docs=this.docs.insert(n,{document:t.mutableCopy(),size:a}),this.size+=a-i,this.indexManager.addToCollectionParentIndex(e,n.path.popLast())}removeEntry(e){const t=this.docs.get(e);t&&(this.docs=this.docs.remove(e),this.size-=t.size)}getEntry(e,t){const n=this.docs.get(t);return Aw.resolve(n?n.document.mutableCopy():Nb.newInvalidDocument(t))}getEntries(e,t){let n=vE();return t.forEach(e=>{const t=this.docs.get(e);n=n.insert(e,t?t.document.mutableCopy():Nb.newInvalidDocument(e))}),Aw.resolve(n)}getDocumentsMatchingQuery(e,t,n,r){let i=vE();const a=t.path,s=new uw(a.child("__id-9223372036854775808__")),o=this.docs.getIteratorFrom(s);for(;o.hasNext();){const{key:e,value:{document:s}}=o.getNext();if(!a.isPrefixOf(e.path))break;e.path.length>a.length+1||Tw(kw(s),n)<=0||(r.has(s.key)||fE(t,s))&&(i=i.insert(s.key,s.mutableCopy()))}return Aw.resolve(i)}getAllFromCollectionGroup(e,t,n,r){Mv(9500)}ni(e,t){return Aw.forEach(this.docs,e=>t(e))}newChangeBuffer(e){return new Nk(this)}getSize(e){return Aw.resolve(this.size)}}class Nk extends wk{constructor(e){super(),this.Mr=e}applyChanges(e){const t=[];return this.changes.forEach((n,r)=>{r.isValidDocument()?t.push(this.Mr.addEntry(e,r)):this.Mr.removeEntry(n)}),Aw.waitFor(t)}getFromCache(e,t){return this.Mr.getEntry(e,t)}getAllFromCache(e,t){return this.Mr.getEntries(e,t)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Rk{constructor(e,t){this._i={},this.overlays={},this.ai=new xw(0),this.ui=!1,this.ui=!0,this.ci=new Ik,this.referenceDelegate=e(this),this.li=new xk(this),this.indexManager=new lk,this.remoteDocumentCache=new Ak(e=>this.referenceDelegate.hi(e)),this.serializer=new sk(t),this.Pi=new _k(this.serializer)}start(){return Promise.resolve()}shutdown(){return this.ui=!1,Promise.resolve()}get started(){return this.ui}setDatabaseDeletedListener(){}setNetworkEnabled(){}getIndexManager(e){return this.indexManager}getDocumentOverlayCache(e){let t=this.overlays[e.toKey()];return t||(t=new kk,this.overlays[e.toKey()]=t),t}getMutationQueue(e,t){let n=this._i[e.toKey()];return n||(n=new Ck(t,this.referenceDelegate),this._i[e.toKey()]=n),n}getGlobalsCache(){return this.ci}getTargetCache(){return this.li}getRemoteDocumentCache(){return this.remoteDocumentCache}getBundleCache(){return this.Pi}runTransaction(e,t,n){Pv("MemoryPersistence","Starting transaction:",e);const r=new Pk(this.ai.next());return this.referenceDelegate.Ti(),n(r).next(e=>this.referenceDelegate.Ei(r).next(()=>e)).toPromise().then(e=>(r.raiseOnCommittedEvent(),e))}Ii(e,t){return Aw.or(Object.values(this._i).map(n=>()=>n.containsKey(e,t)))}}class Pk extends Sw{constructor(e){super(),this.currentSequenceNumber=e}}class Dk{constructor(e){this.persistence=e,this.Ri=new Tk,this.Ai=null}static Vi(e){return new Dk(e)}get di(){if(this.Ai)return this.Ai;throw Mv(60996)}addReference(e,t,n){return this.Ri.addReference(n,t),this.di.delete(n.toString()),Aw.resolve()}removeReference(e,t,n){return this.Ri.removeReference(n,t),this.di.add(n.toString()),Aw.resolve()}markPotentiallyOrphaned(e,t){return this.di.add(t.toString()),Aw.resolve()}removeTarget(e,t){this.Ri.Gr(t.targetId).forEach(e=>this.di.add(e.toString()));const n=this.persistence.getTargetCache();return n.getMatchingKeysForTargetId(e,t.targetId).next(e=>{e.forEach(e=>this.di.add(e.toString()))}).next(()=>n.removeTargetData(e,t))}Ti(){this.Ai=new Set}Ei(e){const t=this.persistence.getRemoteDocumentCache().newChangeBuffer();return Aw.forEach(this.di,n=>{const r=uw.fromPath(n);return this.mi(e,r).next(e=>{e||t.removeEntry(r,_w.min())})}).next(()=>(this.Ai=null,t.apply(e)))}updateLimboDocument(e,t){return this.mi(e,t).next(e=>{e?this.di.delete(t.toString()):this.di.add(t.toString())})}hi(e){return 0}mi(e,t){return Aw.or([()=>Aw.resolve(this.Ri.containsKey(t)),()=>this.persistence.getTargetCache().containsKey(e,t),()=>this.persistence.Ii(e,t)])}}class Ok{constructor(e,t){this.persistence=e,this.fi=new gE(e=>function(e){let t="";for(let n=0;n<e.length;n++)t.length>0&&(t=Ow(t)),t=Dw(e.get(n),t);return Ow(t)}(e.path),(e,t)=>e.isEqual(t)),this.garbageCollector=function(e,t){return new vk(e,t)}(this,t)}static Vi(e,t){return new Ok(e,t)}Ti(){}Ei(e){return Aw.resolve()}forEachTarget(e,t){return this.persistence.getTargetCache().forEachTarget(e,t)}dr(e){const t=this.pr(e);return this.persistence.getTargetCache().getTargetCount(e).next(e=>t.next(t=>e+t))}pr(e){let t=0;return this.mr(e,e=>{t++}).next(()=>t)}mr(e,t){return Aw.forEach(this.fi,(n,r)=>this.wr(e,n,r).next(e=>e?Aw.resolve():t(r)))}removeTargets(e,t,n){return this.persistence.getTargetCache().removeTargets(e,t,n)}removeOrphanedDocuments(e,t){let n=0;const r=this.persistence.getRemoteDocumentCache(),i=r.newChangeBuffer();return r.ni(e,r=>this.wr(e,r,t).next(e=>{e||(n++,i.removeEntry(r,_w.min()))})).next(()=>i.apply(e)).next(()=>n)}markPotentiallyOrphaned(e,t){return this.fi.set(t,e.currentSequenceNumber),Aw.resolve()}removeTarget(e,t){const n=t.withSequenceNumber(e.currentSequenceNumber);return this.persistence.getTargetCache().updateTargetData(e,n)}addReference(e,t,n){return this.fi.set(n,e.currentSequenceNumber),Aw.resolve()}removeReference(e,t,n){return this.fi.set(n,e.currentSequenceNumber),Aw.resolve()}updateLimboDocument(e,t){return this.fi.set(t,e.currentSequenceNumber),Aw.resolve()}hi(e){let t=e.key.toString().length;return e.isFoundDocument()&&(t+=wb(e.data.value)),t}wr(e,t,n){return Aw.or([()=>this.persistence.Ii(e,t),()=>this.persistence.getTargetCache().containsKey(e,t),()=>{const e=this.fi.get(t);return Aw.resolve(void 0!==e&&e>n)}])}getCacheSize(e){return this.persistence.getRemoteDocumentCache().getSize(e)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Lk{constructor(e,t,n,r){this.targetId=e,this.fromCache=t,this.Ts=n,this.Es=r}static Is(e,t){let n=CE(),r=CE();for(const e of t.docChanges)switch(e.type){case 0:n=n.add(e.doc.key);break;case 1:r=r.add(e.doc.key)}return new Lk(e,t.fromCache,n,r)}}
/**
 * @license
 * Copyright 2023 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Uk="LocalStore";class Vk{constructor(e,t,n,r){this.persistence=e,this.Cs=t,this.serializer=r,this.vs=new Uw(Zv),this.Fs=new gE(e=>Zb(e),eE),this.Ms=new Map,this.xs=e.getRemoteDocumentCache(),this.li=e.getTargetCache(),this.Pi=e.getBundleCache(),this.Os(n)}Os(e){this.documentOverlayCache=this.persistence.getDocumentOverlayCache(e),this.indexManager=this.persistence.getIndexManager(e),this.mutationQueue=this.persistence.getMutationQueue(e,this.indexManager),this.localDocuments=new Ek(this.xs,this.mutationQueue,this.documentOverlayCache,this.indexManager),this.xs.setIndexManager(this.indexManager),this.Cs.initialize(this.localDocuments,this.indexManager)}collectGarbage(e){return this.persistence.runTransaction("Collect garbage","readwrite-primary",t=>e.collect(t,this.vs))}}async function zk(e,t){const n=Vv(e);return await n.persistence.runTransaction("Handle user change","readonly",e=>{let r;return n.mutationQueue.getAllMutationBatches(e).next(i=>(r=i,n.Os(t),n.mutationQueue.getAllMutationBatches(e))).next(t=>{const i=[],a=[];let s=CE();for(const e of r){i.push(e.batchId);for(const t of e.mutations)s=s.add(t.key)}for(const e of t){a.push(e.batchId);for(const t of e.mutations)s=s.add(t.key)}return n.localDocuments.getDocuments(e,s).next(e=>({Ns:e,removedBatchIds:i,addedBatchIds:a}))})})}function jk(e){const t=Vv(e);return t.persistence.runTransaction("Get last remote snapshot version","readonly",e=>t.li.getLastRemoteSnapshotVersion(e))}function Bk(e,t){const n=Vv(e),r=t.snapshotVersion;let i=n.vs;return n.persistence.runTransaction("Apply remote event","readwrite-primary",e=>{const a=n.xs.newChangeBuffer({trackRemovals:!0});i=n.vs;const s=[];t.targetChanges.forEach((a,o)=>{const l=i.get(o);if(!l)return;s.push(n.li.removeMatchingKeys(e,a.removedDocuments,o).next(()=>n.li.addMatchingKeys(e,a.addedDocuments,o)));let c=l.withSequenceNumber(e.currentSequenceNumber);null!==t.targetMismatches.get(o)?c=c.withResumeToken(Ww.EMPTY_BYTE_STRING,_w.min()).withLastLimboFreeSnapshotVersion(_w.min()):a.resumeToken.approximateByteSize()>0&&(c=c.withResumeToken(a.resumeToken,r)),i=i.insert(o,c),function(e,t,n){if(0===e.resumeToken.approximateByteSize())return!0;if(t.snapshotVersion.toMicroseconds()-e.snapshotVersion.toMicroseconds()>=3e8)return!0;return n.addedDocuments.size+n.modifiedDocuments.size+n.removedDocuments.size>0}(l,c,a)&&s.push(n.li.updateTargetData(e,c))});let o=vE(),l=CE();if(t.documentUpdates.forEach(r=>{t.resolvedLimboDocuments.has(r)&&s.push(n.persistence.referenceDelegate.updateLimboDocument(e,r))}),s.push(function(e,t,n){let r=CE(),i=CE();return n.forEach(e=>r=r.add(e)),t.getEntries(e,r).next(e=>{let r=vE();return n.forEach((n,a)=>{const s=e.get(n);a.isFoundDocument()!==s.isFoundDocument()&&(i=i.add(n)),a.isNoDocument()&&a.version.isEqual(_w.min())?(t.removeEntry(n,a.readTime),r=r.insert(n,a)):!s.isValidDocument()||a.version.compareTo(s.version)>0||0===a.version.compareTo(s.version)&&s.hasPendingWrites?(t.addEntry(a),r=r.insert(n,a)):Pv(Uk,"Ignoring outdated watch update for ",n,". Current version:",s.version," Watch version:",a.version)}),{Bs:r,Ls:i}})}(e,a,t.documentUpdates).next(e=>{o=e.Bs,l=e.Ls})),!r.isEqual(_w.min())){const t=n.li.getLastRemoteSnapshotVersion(e).next(t=>n.li.setTargetsMetadata(e,e.currentSequenceNumber,r));s.push(t)}return Aw.waitFor(s).next(()=>a.apply(e)).next(()=>n.localDocuments.getLocalViewOfDocuments(e,o,l)).next(()=>o)}).then(e=>(n.vs=i,e))}function qk(e,t){const n=Vv(e);return n.persistence.runTransaction("Get next mutation batch","readonly",e=>(void 0===t&&(t=-1),n.mutationQueue.getNextMutationBatchAfterBatchId(e,t)))}async function Hk(e,t,n){const r=Vv(e),i=r.vs.get(t),a=n?"readwrite":"readwrite-primary";try{n||await r.persistence.runTransaction("Release target",a,e=>r.persistence.referenceDelegate.removeTarget(e,i))}catch(e){if(!Nw(e))throw e;Pv(Uk,`Failed to update sequence numbers for target ${t}: ${e}`)}r.vs=r.vs.remove(t),r.Fs.delete(i.target)}function Wk(e,t,n){const r=Vv(e);let i=_w.min(),a=CE();return r.persistence.runTransaction("Execute query","readwrite",e=>function(e,t,n){const r=Vv(e),i=r.Fs.get(n);return void 0!==i?Aw.resolve(r.vs.get(i)):r.li.getTargetData(t,n)}(r,e,oE(t)).next(t=>{if(t)return i=t.lastLimboFreeSnapshotVersion,r.li.getMatchingKeysForTargetId(e,t.targetId).next(e=>{a=e})}).next(()=>r.Cs.getDocumentsMatchingQuery(e,t,n?i:_w.min(),n?a:CE())).next(e=>(function(e,t,n){let r=e.Ms.get(t)||_w.min();n.forEach((e,t)=>{t.readTime.compareTo(r)>0&&(r=t.readTime)}),e.Ms.set(t,r)}(r,function(e){return e.collectionGroup||(e.path.length%2==1?e.path.lastSegment():e.path.get(e.path.length-2))}(t),e),{documents:e,ks:a})))}class $k{constructor(){this.activeTargetIds=AE}Qs(e){this.activeTargetIds=this.activeTargetIds.add(e)}Gs(e){this.activeTargetIds=this.activeTargetIds.delete(e)}Ws(){const e={activeTargetIds:this.activeTargetIds.toArray(),updateTimeMs:Date.now()};return JSON.stringify(e)}}class Kk{constructor(){this.vo=new $k,this.Fo={},this.onlineStateHandler=null,this.sequenceNumberHandler=null}addPendingMutation(e){}updateMutationState(e,t,n){}addLocalQueryTarget(e,t=!0){return t&&this.vo.Qs(e),this.Fo[e]||"not-current"}updateQueryState(e,t,n){this.Fo[e]=t}removeLocalQueryTarget(e){this.vo.Gs(e)}isLocalQueryTarget(e){return this.vo.activeTargetIds.has(e)}clearQueryState(e){delete this.Fo[e]}getAllActiveQueryTargets(){return this.vo.activeTargetIds}isActiveQueryTarget(e){return this.vo.activeTargetIds.has(e)}start(){return this.vo=new $k,Promise.resolve()}handleUserChange(e,t,n){}setOnlineState(e){}shutdown(){}writeSequenceNumber(e){}notifyBundleLoaded(e){}}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Qk="ConnectivityMonitor";class Yk{constructor(){this.xo=()=>this.Oo(),this.No=()=>this.Bo(),this.Lo=[],this.ko()}Mo(e){this.Lo.push(e)}shutdown(){window.removeEventListener("online",this.xo),window.removeEventListener("offline",this.No)}ko(){window.addEventListener("online",this.xo),window.addEventListener("offline",this.No)}Oo(){Pv(Qk,"Network connectivity changed: AVAILABLE");for(const e of this.Lo)e(0)}Bo(){Pv(Qk,"Network connectivity changed: UNAVAILABLE");for(const e of this.Lo)e(1)}static v(){return"undefined"!=typeof window&&void 0!==window.addEventListener&&void 0!==window.removeEventListener}}
/**
 * @license
 * Copyright 2023 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Jk=null;function Xk(){return null===Jk?Jk=268435456+Math.round(2147483648*Math.random()):Jk++,"0x"+Jk.toString(16)
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function oI(e){return new R_(e,!0)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const cI="PersistentStream";class uI{constructor(e,t,n,r,i,a,s,o){this.Ci=e,this.S_=n,this.b_=r,this.connection=i,this.authCredentialsProvider=a,this.appCheckCredentialsProvider=s,this.listener=o,this.state=0,this.D_=0,this.C_=null,this.v_=null,this.stream=null,this.F_=0,this.M_=new lI(e,t)}x_(){return 1===this.state||5===this.state||this.O_()}O_(){return 2===this.state||3===this.state}start(){this.F_=0,4!==this.state?this.auth():this.N_()}async stop(){this.x_()&&await this.close(0)}B_(){this.state=0,this.M_.reset()}L_(){this.O_()&&null===this.C_&&(this.C_=this.Ci.enqueueAfterDelay(this.S_,6e4,()=>this.k_()))}q_(e){this.K_(),this.stream.send(e)}async k_(){if(this.O_())return this.close(0)}K_(){this.C_&&(this.C_.cancel(),this.C_=null)}U_(){this.v_&&(this.v_.cancel(),this.v_=null)}async close(e,t){this.K_(),this.U_(),this.M_.cancel(),this.D_++,4!==e?this.M_.reset():t&&t.code===zv.RESOURCE_EXHAUSTED?(Dv(t.toString()),Dv("Using maximum backoff delay to prevent overloading the backend."),this.M_.g_()):t&&t.code===zv.UNAUTHENTICATED&&3!==this.state&&(this.authCredentialsProvider.invalidateToken(),this.appCheckCredentialsProvider.invalidateToken()),null!==this.stream&&(this.W_(),this.stream.close(),this.stream=null),this.state=e,await this.listener.t_(t)}W_(){}auth(){this.state=1;const e=this.Q_(this.D_),t=this.D_;Promise.all([this.authCredentialsProvider.getToken(),this.appCheckCredentialsProvider.getToken()]).then(([e,n])=>{this.D_===t&&this.G_(e,n)},t=>{e(()=>{const e=new jv(zv.UNKNOWN,"Fetching auth token failed: "+t.message);return this.z_(e)})})}G_(e,t){const n=this.Q_(this.D_);this.stream=this.j_(e,t),this.stream.Zo(()=>{n(()=>this.listener.Zo())}),this.stream.Yo(()=>{n(()=>(this.state=2,this.v_=this.Ci.enqueueAfterDelay(this.b_,1e4,()=>(this.O_()&&(this.state=3),Promise.resolve())),this.listener.Yo()))}),this.stream.t_(e=>{n(()=>this.z_(e))}),this.stream.onMessage(e=>{n(()=>1==++this.F_?this.J_(e):this.onNext(e))})}N_(){this.state=5,this.M_.p_(async()=>{this.state=0,this.start()})}z_(e){return Pv(cI,`close with error: ${e}`),this.stream=null,this.close(4,e)}Q_(e){return t=>{this.Ci.enqueueAndForget(()=>this.D_===e?t():(Pv(cI,"stream callback skipped by getCloseGuardedDispatcher."),Promise.resolve()))}}}class hI extends uI{constructor(e,t,n,r,i,a){super(e,"listen_stream_connection_backoff","listen_stream_idle","health_check_timeout",t,n,r,a),this.serializer=i}j_(e,t){return this.connection.T_("Listen",e,t)}J_(e){return this.onNext(e)}onNext(e){this.M_.reset();const t=function(e,t){let n;if("targetChange"in t){t.targetChange;const i="NO_CHANGE"===(r=t.targetChange.targetChangeType||"NO_CHANGE")?0:"ADD"===r?1:"REMOVE"===r?2:"CURRENT"===r?3:"RESET"===r?4:Mv(39313,{state:r}),a=t.targetChange.targetIds||[],s=function(e,t){return e.useProto3Json?(Uv(void 0===t||"string"==typeof t,58123),Ww.fromBase64String(t||"")):(Uv(void 0===t||t instanceof Buffer||t instanceof Uint8Array,16193),Ww.fromUint8Array(t||new Uint8Array))}(e,t.targetChange.resumeToken),o=t.targetChange.cause,l=o&&function(e){const t=void 0===e.code?zv.UNKNOWN:f_(e.code);return new jv(t,e.message||"")}(o);n=new k_(i,a,s,l||null)}else if("documentChange"in t){t.documentChange;const r=t.documentChange;r.document,r.document.name,r.document.updateTime;const i=j_(e,r.document.name),a=M_(r.document.updateTime),s=r.document.createTime?M_(r.document.createTime):_w.min(),o=new Cb({mapValue:{fields:r.document.fields}}),l=Nb.newFoundDocument(i,a,s,o),c=r.targetIds||[],u=r.removedTargetIds||[];n=new E_(c,u,l.key,l)}else if("documentDelete"in t){t.documentDelete;const r=t.documentDelete;r.document;const i=j_(e,r.document),a=r.readTime?M_(r.readTime):_w.min(),s=Nb.newNoDocument(i,a),o=r.removedTargetIds||[];n=new E_([],o,s.key,s)}else if("documentRemove"in t){t.documentRemove;const r=t.documentRemove;r.document;const i=j_(e,r.document),a=r.removedTargetIds||[];n=new E_([],a,i,null)}else{if(!("filter"in t))return Mv(11601,{Vt:t});{t.filter;const e=t.filter;e.targetId;const{count:r=0,unchangedNames:i}=e,a=new u_(r,i),s=e.targetId;n=new __(s,a)}}var r;return n}(this.serializer,e),n=function(e){if(!("targetChange"in e))return _w.min();const t=e.targetChange;return t.targetIds&&t.targetIds.length?_w.min():t.readTime?M_(t.readTime):_w.min()}(e);return this.listener.H_(t,n)}Z_(e){const t={};t.database=q_(this.serializer),t.addTarget=function(e,t){let n;const r=t.target;if(n=tE(r)?{documents:$_(e,r)}:{query:K_(e,r).ft},n.targetId=t.targetId,t.resumeToken.approximateByteSize()>0){n.resumeToken=O_(e,t.resumeToken);const r=P_(e,t.expectedCount);null!==r&&(n.expectedCount=r)}else if(t.snapshotVersion.compareTo(_w.min())>0){n.readTime=D_(e,t.snapshotVersion.toTimestamp());const r=P_(e,t.expectedCount);null!==r&&(n.expectedCount=r)}return n}(this.serializer,e);const n=function(e,t){const n=function(e){switch(e){case"TargetPurposeListen":return null;case"TargetPurposeExistenceFilterMismatch":return"existence-filter-mismatch";case"TargetPurposeExistenceFilterMismatchBloom":return"existence-filter-mismatch-bloom";case"TargetPurposeLimboResolution":return"limbo-document";default:return Mv(28987,{purpose:e})}}(t.purpose);return null==n?null:{"goog-listen-tags":n}}(this.serializer,e);n&&(t.labels=n),this.q_(t)}X_(e){const t={};t.database=q_(this.serializer),t.removeTarget=e,this.q_(t)}}class dI extends uI{constructor(e,t,n,r,i,a){super(e,"write_stream_connection_backoff","write_stream_idle","health_check_timeout",t,n,r,a),this.serializer=i}get Y_(){return this.F_>0}start(){this.lastStreamToken=void 0,super.start()}W_(){this.Y_&&this.ea([])}j_(e,t){return this.connection.T_("Write",e,t)}J_(e){return Uv(!!e.streamToken,31322),this.lastStreamToken=e.streamToken,Uv(!e.writeResults||0===e.writeResults.length,55816),this.listener.ta()}onNext(e){Uv(!!e.streamToken,12678),this.lastStreamToken=e.streamToken,this.M_.reset();const t=function(e,t){return e&&e.length>0?(Uv(void 0!==t,14353),e.map(e=>function(e,t){let n=e.updateTime?M_(e.updateTime):M_(t);return n.isEqual(_w.min())&&(n=M_(t)),new WE(n,e.transformResults||[])}(e,t))):[]}(e.writeResults,e.commitTime),n=M_(e.commitTime);return this.listener.na(n,t)}ra(){const e={};e.database=q_(this.serializer),this.q_(e)}ea(e){const t={streamToken:this.lastStreamToken,writes:e.map(e=>function(e,t){let n;if(t instanceof e_)n={update:W_(e,t.key,t.value)};else if(t instanceof a_)n={delete:z_(e,t.key)};else if(t instanceof t_)n={update:W_(e,t.key,t.data),updateMask:nk(t.fieldMask)};else{if(!(t instanceof s_))return Mv(16599,{dt:t.type});n={verify:z_(e,t.key)}}return t.fieldTransforms.length>0&&(n.updateTransforms=t.fieldTransforms.map(e=>function(e,t){const n=t.transform;if(n instanceof ME)return{fieldPath:t.field.canonicalString(),setToServerValue:"REQUEST_TIME"};if(n instanceof FE)return{fieldPath:t.field.canonicalString(),appendMissingElements:{values:n.elements}};if(n instanceof VE)return{fieldPath:t.field.canonicalString(),removeAllFromArray:{values:n.elements}};if(n instanceof jE)return{fieldPath:t.field.canonicalString(),increment:n.Ae};throw Mv(20930,{transform:t.transform})}(0,e))),t.precondition.isNone||(n.currentDocument=(r=e,void 0!==(i=t.precondition).updateTime?{updateTime:L_(r,i.updateTime)}:void 0!==i.exists?{exists:i.exists}:Mv(27497))),n;var r,i}(this.serializer,e))};this.q_(t)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const gI="RemoteStore";class yI{constructor(e,t,n,r,i){this.localStore=e,this.datastore=t,this.asyncQueue=n,this.remoteSyncer={},this.Ta=[],this.Ea=new Map,this.Ia=new Set,this.Ra=[],this.Aa=i,this.Aa.Mo(e=>{n.enqueueAndForget(async()=>{SI(this)&&(Pv(gI,"Restarting streams for network reachability change."),await async function(e){const t=Vv(e);t.Ia.add(4),await wI(t),t.Va.set("Unknown"),t.Ia.delete(4),await vI(t)}(this))})}),this.Va=new mI(n,r)}}async function vI(e){if(SI(e))for(const t of e.Ra)await t(!0)}async function wI(e){for(const t of e.Ra)await t(!1)}function bI(e,t){const n=Vv(e);n.Ea.has(t.targetId)||(n.Ea.set(t.targetId,t),TI(n)?II(n):HI(n).O_()&&_I(n,t))}function EI(e,t){const n=Vv(e),r=HI(n);n.Ea.delete(t),r.O_()&&kI(n,t),0===n.Ea.size&&(r.O_()?r.L_():SI(n)&&n.Va.set("Unknown"))}function _I(e,t){if(e.da.$e(t.targetId),t.resumeToken.approximateByteSize()>0||t.snapshotVersion.compareTo(_w.min())>0){const n=e.remoteSyncer.getRemoteKeysForTarget(t.targetId).size;t=t.withExpectedCount(n)}HI(e).Z_(t)}function kI(e,t){e.da.$e(t),HI(e).X_(t)}function II(e){e.da=new T_({getRemoteKeysForTarget:t=>e.remoteSyncer.getRemoteKeysForTarget(t),At:t=>e.Ea.get(t)||null,ht:()=>e.datastore.serializer.databaseId}),HI(e).start(),e.Va.ua()}function TI(e){return SI(e)&&!HI(e).x_()&&e.Ea.size>0}function SI(e){return 0===Vv(e).Ia.size}function CI(e){e.da=void 0}async function AI(e){e.Va.set("Online")}async function NI(e){e.Ea.forEach((t,n)=>{_I(e,t)})}async function xI(e,t){CI(e),TI(e)?(e.Va.ha(t),II(e)):e.Va.set("Unknown")}async function RI(e,t,n){if(e.Va.set("Online"),t instanceof k_&&2===t.state&&t.cause)try{await async function(e,t){const n=t.cause;for(const r of t.targetIds)e.Ea.has(r)&&(await e.remoteSyncer.rejectListen(r,n),e.Ea.delete(r),e.da.removeTarget(r))}(e,t)}catch(n){Pv(gI,"Failed to remove targets %s: %s ",t.targetIds.join(","),n),await PI(e,n)}else if(t instanceof E_?e.da.Xe(t):t instanceof __?e.da.st(t):e.da.tt(t),!n.isEqual(_w.min()))try{const t=await jk(e.localStore);n.compareTo(t)>=0&&await function(e,t){const n=e.da.Tt(t);return n.targetChanges.forEach((n,r)=>{if(n.resumeToken.approximateByteSize()>0){const i=e.Ea.get(r);i&&e.Ea.set(r,i.withResumeToken(n.resumeToken,t))}}),n.targetMismatches.forEach((t,n)=>{const r=e.Ea.get(t);if(!r)return;e.Ea.set(t,r.withResumeToken(Ww.EMPTY_BYTE_STRING,r.snapshotVersion)),kI(e,t);const i=new ak(r.target,t,n,r.sequenceNumber);_I(e,i)}),e.remoteSyncer.applyRemoteEvent(n)}(e,n)}catch(t){Pv(gI,"Failed to raise snapshot:",t),await PI(e,t)}}async function PI(e,t,n){if(!Nw(t))throw t;e.Ia.add(1),await wI(e),e.Va.set("Offline"),n||(n=()=>jk(e.localStore)),e.asyncQueue.enqueueRetryable(async()=>{Pv(gI,"Retrying IndexedDB access"),await n(),e.Ia.delete(1),await vI(e)})}function DI(e,t){return t().catch(n=>PI(e,n,t))}async function OI(e){const t=Vv(e),n=WI(t);let r=t.Ta.length>0?t.Ta[t.Ta.length-1].batchId:-1;for(;LI(t);)try{const e=await qk(t.localStore,r);if(null===e){0===t.Ta.length&&n.L_();break}r=e.batchId,MI(t,e)}catch(e){await PI(t,e)}FI(t)&&UI(t)}function LI(e){return SI(e)&&e.Ta.length<10}function MI(e,t){e.Ta.push(t);const n=WI(e);n.O_()&&n.Y_&&n.ea(t.mutations)}function FI(e){return SI(e)&&!WI(e).x_()&&e.Ta.length>0}function UI(e){WI(e).start()}async function VI(e){WI(e).ra()}async function zI(e){const t=WI(e);for(const n of e.Ta)t.ea(n.mutations)}async function jI(e,t,n){const r=e.Ta.shift(),i=l_.from(r,t,n);await DI(e,()=>e.remoteSyncer.applySuccessfulWrite(i)),await OI(e)}async function BI(e,t){t&&WI(e).Y_&&await async function(e,t){if(function(e){switch(e){case zv.OK:return Mv(64938);case zv.CANCELLED:case zv.UNKNOWN:case zv.DEADLINE_EXCEEDED:case zv.RESOURCE_EXHAUSTED:case zv.INTERNAL:case zv.UNAVAILABLE:case zv.UNAUTHENTICATED:return!1;case zv.INVALID_ARGUMENT:case zv.NOT_FOUND:case zv.ALREADY_EXISTS:case zv.PERMISSION_DENIED:case zv.FAILED_PRECONDITION:case zv.ABORTED:case zv.OUT_OF_RANGE:case zv.UNIMPLEMENTED:case zv.DATA_LOSS:return!0;default:return Mv(15467,{code:e})}}(n=t.code)&&n!==zv.ABORTED){const n=e.Ta.shift();WI(e).B_(),await DI(e,()=>e.remoteSyncer.rejectFailedWrite(n.batchId,t)),await OI(e)}var n}(e,t),FI(e)&&UI(e)}async function qI(e,t){const n=Vv(e);n.asyncQueue.verifyOperationInProgress(),Pv(gI,"RemoteStore received new credentials");const r=SI(n);n.Ia.add(3),await wI(n),r&&n.Va.set("Unknown"),await n.remoteSyncer.handleCredentialChange(t),n.Ia.delete(3),await vI(n)}function HI(e){return e.ma||(e.ma=function(e,t,n){const r=Vv(e);return r.sa(),new hI(t,r.connection,r.authCredentials,r.appCheckCredentials,r.serializer,n)}(e.datastore,e.asyncQueue,{Zo:AI.bind(null,e),Yo:NI.bind(null,e),t_:xI.bind(null,e),H_:RI.bind(null,e)}),e.Ra.push(async t=>{t?(e.ma.B_(),TI(e)?II(e):e.Va.set("Unknown")):(await e.ma.stop(),CI(e))})),e.ma}function WI(e){return e.fa||(e.fa=function(e,t,n){const r=Vv(e);return r.sa(),new dI(t,r.connection,r.authCredentials,r.appCheckCredentials,r.serializer,n)}(e.datastore,e.asyncQueue,{Zo:()=>Promise.resolve(),Yo:VI.bind(null,e),t_:BI.bind(null,e),ta:zI.bind(null,e),na:jI.bind(null,e)}),e.Ra.push(async t=>{t?(e.fa.B_(),await OI(e)):(await e.fa.stop(),e.Ta.length>0&&(Pv(gI,`Stopping write stream with ${e.Ta.length} pending writes`),e.Ta=[]))})),e.fa
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */}class $I{constructor(e,t,n,r,i){this.asyncQueue=e,this.timerId=t,this.targetTimeMs=n,this.op=r,this.removalCallback=i,this.deferred=new Bv,this.then=this.deferred.promise.then.bind(this.deferred.promise),this.deferred.promise.catch(e=>{})}get promise(){return this.deferred.promise}static createAndSchedule(e,t,n,r,i){const a=Date.now()+n,s=new $I(e,t,a,r,i);return s.start(n),s}start(e){this.timerHandle=setTimeout(()=>this.handleDelayElapsed(),e)}skipDelay(){return this.handleDelayElapsed()}cancel(e){null!==this.timerHandle&&(this.clearTimeout(),this.deferred.reject(new jv(zv.CANCELLED,"Operation cancelled"+(e?": "+e:""))))}handleDelayElapsed(){this.asyncQueue.enqueueAndForget(()=>null!==this.timerHandle?(this.clearTimeout(),this.op().then(e=>this.deferred.resolve(e))):Promise.resolve())}clearTimeout(){null!==this.timerHandle&&(this.removalCallback(this),clearTimeout(this.timerHandle),this.timerHandle=null)}}function KI(e,t){if(Dv("AsyncQueue",`${t}: ${e}`),Nw(e))return new jv(zv.UNAVAILABLE,`${t}: ${e}`);throw e}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class lT{constructor(e){this.key=e}}class cT{constructor(e){this.key=e}}class uT{constructor(e,t){this.query=e,this.Za=t,this.Xa=null,this.hasCachedResults=!1,this.current=!1,this.Ya=CE(),this.mutatedKeys=CE(),this.eu=pE(e),this.tu=new GI(this.eu)}get nu(){return this.Za}ru(e,t){const n=t?t.iu:new QI,r=t?t.tu:this.tu;let i=t?t.mutatedKeys:this.mutatedKeys,a=r,s=!1;const o="F"===this.query.limitType&&r.size===this.query.limit?r.last():null,l="L"===this.query.limitType&&r.size===this.query.limit?r.first():null;if(e.inorderTraversal((e,t)=>{const c=r.get(e),u=fE(this.query,t)?t:null,h=!!c&&this.mutatedKeys.has(c.key),d=!!u&&(u.hasLocalMutations||this.mutatedKeys.has(u.key)&&u.hasCommittedMutations);let f=!1;c&&u?c.data.isEqual(u.data)?h!==d&&(n.track({type:3,doc:u}),f=!0):this.su(c,u)||(n.track({type:2,doc:u}),f=!0,(o&&this.eu(u,o)>0||l&&this.eu(u,l)<0)&&(s=!0)):!c&&u?(n.track({type:0,doc:u}),f=!0):c&&!u&&(n.track({type:1,doc:c}),f=!0,(o||l)&&(s=!0)),f&&(u?(a=a.add(u),i=d?i.add(e):i.delete(e)):(a=a.delete(e),i=i.delete(e)))}),null!==this.query.limit)for(;a.size>this.query.limit;){const e="F"===this.query.limitType?a.last():a.first();a=a.delete(e.key),i=i.delete(e.key),n.track({type:1,doc:e})}return{tu:a,iu:n,bs:s,mutatedKeys:i}}su(e,t){return e.hasLocalMutations&&t.hasCommittedMutations&&!t.hasLocalMutations}applyChanges(e,t,n,r){const i=this.tu;this.tu=e.tu,this.mutatedKeys=e.mutatedKeys;const a=e.iu.ya();a.sort((e,t)=>function(e,t){const n=e=>{switch(e){case 0:return 1;case 2:case 3:return 2;case 1:return 0;default:return Mv(20277,{Vt:e})}};return n(e)-n(t)}(e.type,t.type)||this.eu(e.doc,t.doc)),this.ou(n),r=r??!1;const s=t&&!r?this._u():[],o=0===this.Ya.size&&this.current&&!r?1:0,l=o!==this.Xa;return this.Xa=o,0!==a.length||l?{snapshot:new YI(this.query,e.tu,i,a,e.mutatedKeys,0===o,l,!1,!!n&&n.resumeToken.approximateByteSize()>0),au:s}:{au:s}}va(e){return this.current&&"Offline"===e?(this.current=!1,this.applyChanges({tu:this.tu,iu:new QI,mutatedKeys:this.mutatedKeys,bs:!1},!1)):{au:[]}}uu(e){return!this.Za.has(e)&&!!this.tu.has(e)&&!this.tu.get(e).hasLocalMutations}ou(e){e&&(e.addedDocuments.forEach(e=>this.Za=this.Za.add(e)),e.modifiedDocuments.forEach(e=>{}),e.removedDocuments.forEach(e=>this.Za=this.Za.delete(e)),this.current=e.current)}_u(){if(!this.current)return[];const e=this.Ya;this.Ya=CE(),this.tu.forEach(e=>{this.uu(e.key)&&(this.Ya=this.Ya.add(e.key))});const t=[];return e.forEach(e=>{this.Ya.has(e)||t.push(new cT(e))}),this.Ya.forEach(n=>{e.has(n)||t.push(new lT(n))}),t}cu(e){this.Za=e.ks,this.Ya=CE();const t=this.ru(e.documents);return this.applyChanges(t,!0)}lu(){return YI.fromInitialDocuments(this.query,this.tu,this.mutatedKeys,0===this.Xa,this.hasCachedResults)}}const hT="SyncEngine";class dT{constructor(e,t,n){this.query=e,this.targetId=t,this.view=n}}class fT{constructor(e){this.key=e,this.hu=!1}}class pT{constructor(e,t,n,r,i,a){this.localStore=e,this.remoteStore=t,this.eventManager=n,this.sharedClientState=r,this.currentUser=i,this.maxConcurrentLimboResolutions=a,this.Pu={},this.Tu=new gE(e=>hE(e),uE),this.Eu=new Map,this.Iu=new Set,this.Ru=new Uw(uw.comparator),this.Au=new Map,this.Vu=new Tk,this.du={},this.mu=new Map,this.fu=fk.ar(),this.onlineState="Unknown",this.gu=void 0}get isPrimaryClient(){return!0===this.gu}}async function mT(e,t,n=!0){const r=MT(e);let i;const a=r.Tu.get(t);return a?(r.sharedClientState.addLocalQueryTarget(a.targetId),i=a.view.lu()):i=await yT(r,t,n,!0),i}async function gT(e,t){const n=MT(e);await yT(n,t,!0,!1)}async function yT(e,t,n,r){const i=await function(e,t){const n=Vv(e);return n.persistence.runTransaction("Allocate target","readwrite",e=>{let r;return n.li.getTargetData(e,t).next(i=>i?(r=i,Aw.resolve(r)):n.li.allocateTargetId(e).next(i=>(r=new ak(t,i,"TargetPurposeListen",e.currentSequenceNumber),n.li.addTargetData(e,r).next(()=>r))))}).then(e=>{const r=n.vs.get(e.targetId);return(null===r||e.snapshotVersion.compareTo(r.snapshotVersion)>0)&&(n.vs=n.vs.insert(e.targetId,e),n.Fs.set(t,e.targetId)),e})}(e.localStore,oE(t)),a=i.targetId,s=e.sharedClientState.addLocalQueryTarget(a,n);let o;return r&&(o=await async function(e,t,n,r,i){e.pu=(t,n,r)=>async function(e,t,n,r){let i=t.view.ru(n);i.bs&&(i=await Wk(e.localStore,t.query,!1).then(({documents:e})=>t.view.ru(e,i)));const a=r&&r.targetChanges.get(t.targetId),s=r&&null!=r.targetMismatches.get(t.targetId),o=t.view.applyChanges(i,e.isPrimaryClient,a,s);return xT(e,t.targetId,o.au),o.snapshot}(e,t,n,r);const a=await Wk(e.localStore,t,!0),s=new uT(t,a.ks),o=s.ru(a.documents),l=b_.createSynthesizedTargetChangeForCurrentChange(n,r&&"Offline"!==e.onlineState,i),c=s.applyChanges(o,e.isPrimaryClient,l);xT(e,n,c.au);const u=new dT(t,n,s);return e.Tu.set(t,u),e.Eu.has(n)?e.Eu.get(n).push(t):e.Eu.set(n,[t]),c.snapshot}(e,t,a,"current"===s,i.resumeToken)),e.isPrimaryClient&&n&&bI(e.remoteStore,i),o}async function vT(e,t,n){const r=Vv(e),i=r.Tu.get(t),a=r.Eu.get(i.targetId);if(a.length>1)return r.Eu.set(i.targetId,a.filter(e=>!uE(e,t))),void r.Tu.delete(t);r.isPrimaryClient?(r.sharedClientState.removeLocalQueryTarget(i.targetId),r.sharedClientState.isActiveQueryTarget(i.targetId)||await Hk(r.localStore,i.targetId,!1).then(()=>{r.sharedClientState.clearQueryState(i.targetId),n&&EI(r.remoteStore,i.targetId),AT(r,i.targetId)}).catch(Cw)):(AT(r,i.targetId),await Hk(r.localStore,i.targetId,!0))}async function wT(e,t){const n=Vv(e),r=n.Tu.get(t),i=n.Eu.get(r.targetId);n.isPrimaryClient&&1===i.length&&(n.sharedClientState.removeLocalQueryTarget(r.targetId),EI(n.remoteStore,r.targetId))}async function bT(e,t,n){const r=function(e){const t=Vv(e);return t.remoteStore.remoteSyncer.applySuccessfulWrite=IT.bind(null,t),t.remoteStore.remoteSyncer.rejectFailedWrite=TT.bind(null,t),t}(e);try{const e=await function(e,t){const n=Vv(e),r=Ew.now(),i=t.reduce((e,t)=>e.add(t.key),CE());let a,s;return n.persistence.runTransaction("Locally write mutations","readwrite",e=>{let o=vE(),l=CE();return n.xs.getEntries(e,i).next(e=>{o=e,o.forEach((e,t)=>{t.isValidDocument()||(l=l.add(e))})}).next(()=>n.localDocuments.getOverlayedDocuments(e,o)).next(i=>{a=i;const s=[];for(const e of t){const t=XE(e,a.get(e.key).overlayedDocument);null!=t&&s.push(new t_(e.key,t,Ab(t.value.mapValue),$E.exists(!0)))}return n.mutationQueue.addMutationBatch(e,r,s,t)}).next(t=>{s=t;const r=t.applyToLocalDocumentSet(a,l);return n.documentOverlayCache.saveOverlays(e,t.batchId,r)})}).then(()=>({batchId:s.batchId,changes:EE(a)}))}(r.localStore,t);r.sharedClientState.addPendingMutation(e.batchId),function(e,t,n){let r=e.du[e.currentUser.toKey()];r||(r=new Uw(Zv)),r=r.insert(t,n),e.du[e.currentUser.toKey()]=r}(r,e.batchId,n),await DT(r,e.changes),await OI(r.remoteStore)}catch(e){const t=KI(e,"Failed to persist write");n.reject(t)}}async function ET(e,t){const n=Vv(e);try{const e=await Bk(n.localStore,t);t.targetChanges.forEach((e,t)=>{const r=n.Au.get(t);r&&(Uv(e.addedDocuments.size+e.modifiedDocuments.size+e.removedDocuments.size<=1,22616),e.addedDocuments.size>0?r.hu=!0:e.modifiedDocuments.size>0?Uv(r.hu,14607):e.removedDocuments.size>0&&(Uv(r.hu,42227),r.hu=!1))}),await DT(n,e,t)}catch(e){await Cw(e)}}function _T(e,t,n){const r=Vv(e);if(r.isPrimaryClient&&0===n||!r.isPrimaryClient&&1===n){const e=[];r.Tu.forEach((n,r)=>{const i=r.view.va(t);i.snapshot&&e.push(i.snapshot)}),function(e,t){const n=Vv(e);n.onlineState=t;let r=!1;n.queries.forEach((e,n)=>{for(const e of n.Sa)e.va(t)&&(r=!0)}),r&&iT(n)}(r.eventManager,t),e.length&&r.Pu.H_(e),r.onlineState=t,r.isPrimaryClient&&r.sharedClientState.setOnlineState(t)}}async function kT(e,t,n){const r=Vv(e);r.sharedClientState.updateQueryState(t,"rejected",n);const i=r.Au.get(t),a=i&&i.key;if(a){let e=new Uw(uw.comparator);e=e.insert(a,Nb.newNoDocument(a,_w.min()));const n=CE().add(a),i=new w_(_w.min(),new Map,new Uw(Zv),e,n);await ET(r,i),r.Ru=r.Ru.remove(a),r.Au.delete(t),PT(r)}else await Hk(r.localStore,t,!1).then(()=>AT(r,t,n)).catch(Cw)}async function IT(e,t){const n=Vv(e),r=t.batch.batchId;try{const e=await function(e,t){const n=Vv(e);return n.persistence.runTransaction("Acknowledge batch","readwrite-primary",e=>{const r=t.batch.keys(),i=n.xs.newChangeBuffer({trackRemovals:!0});return function(e,t,n,r){const i=n.batch,a=i.keys();let s=Aw.resolve();return a.forEach(e=>{s=s.next(()=>r.getEntry(t,e)).next(t=>{const a=n.docVersions.get(e);Uv(null!==a,48541),t.version.compareTo(a)<0&&(i.applyToRemoteDocument(t,n),t.isValidDocument()&&(t.setReadTime(n.commitVersion),r.addEntry(t)))})}),s.next(()=>e.mutationQueue.removeMutationBatch(t,i))}(n,e,t,i).next(()=>i.apply(e)).next(()=>n.mutationQueue.performConsistencyCheck(e)).next(()=>n.documentOverlayCache.removeOverlaysForBatchId(e,r,t.batch.batchId)).next(()=>n.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(e,function(e){let t=CE();for(let n=0;n<e.mutationResults.length;++n)e.mutationResults[n].transformResults.length>0&&(t=t.add(e.batch.mutations[n].key));return t}(t))).next(()=>n.localDocuments.getDocuments(e,r))})}(n.localStore,t);CT(n,r,null),ST(n,r),n.sharedClientState.updateMutationState(r,"acknowledged"),await DT(n,e)}catch(e){await Cw(e)}}async function TT(e,t,n){const r=Vv(e);try{const e=await function(e,t){const n=Vv(e);return n.persistence.runTransaction("Reject batch","readwrite-primary",e=>{let r;return n.mutationQueue.lookupMutationBatch(e,t).next(t=>(Uv(null!==t,37113),r=t.keys(),n.mutationQueue.removeMutationBatch(e,t))).next(()=>n.mutationQueue.performConsistencyCheck(e)).next(()=>n.documentOverlayCache.removeOverlaysForBatchId(e,r,t)).next(()=>n.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(e,r)).next(()=>n.localDocuments.getDocuments(e,r))})}(r.localStore,t);CT(r,t,n),ST(r,t),r.sharedClientState.updateMutationState(t,"rejected",n),await DT(r,e)}catch(e){await Cw(e)}}function ST(e,t){(e.mu.get(t)||[]).forEach(e=>{e.resolve()}),e.mu.delete(t)}function CT(e,t,n){const r=Vv(e);let i=r.du[r.currentUser.toKey()];if(i){const e=i.get(t);e&&(n?e.reject(n):e.resolve(),i=i.remove(t)),r.du[r.currentUser.toKey()]=i}}function AT(e,t,n=null){e.sharedClientState.removeLocalQueryTarget(t);for(const r of e.Eu.get(t))e.Tu.delete(r),n&&e.Pu.yu(r,n);e.Eu.delete(t),e.isPrimaryClient&&e.Vu.Gr(t).forEach(t=>{e.Vu.containsKey(t)||NT(e,t)})}function NT(e,t){e.Iu.delete(t.path.canonicalString());const n=e.Ru.get(t);null!==n&&(EI(e.remoteStore,n),e.Ru=e.Ru.remove(t),e.Au.delete(n),PT(e))}function xT(e,t,n){for(const r of n)r instanceof lT?(e.Vu.addReference(r.key,t),RT(e,r)):r instanceof cT?(Pv(hT,"Document no longer in limbo: "+r.key),e.Vu.removeReference(r.key,t),e.Vu.containsKey(r.key)||NT(e,r.key)):Mv(19791,{wu:r})}function RT(e,t){const n=t.key,r=n.path.canonicalString();e.Ru.get(n)||e.Iu.has(r)||(Pv(hT,"New document in limbo: "+n),e.Iu.add(r),PT(e))}function PT(e){for(;e.Iu.size>0&&e.Ru.size<e.maxConcurrentLimboResolutions;){const t=e.Iu.values().next().value;e.Iu.delete(t);const n=new uw(ow.fromString(t)),r=e.fu.next();e.Au.set(r,new fT(n)),e.Ru=e.Ru.insert(n,r),bI(e.remoteStore,new ak(oE(rE(n.path)),r,"TargetPurposeLimboResolution",xw.ce))}}async function DT(e,t,n){const r=Vv(e),i=[],a=[],s=[];r.Tu.isEmpty()||(r.Tu.forEach((e,o)=>{s.push(r.pu(o,t,n).then(e=>{if((e||n)&&r.isPrimaryClient){const t=e?!e.fromCache:n?.targetChanges.get(o.targetId)?.current;r.sharedClientState.updateQueryState(o.targetId,t?"current":"not-current")}if(e){i.push(e);const t=Lk.Is(o.targetId,e);a.push(t)}}))}),await Promise.all(s),r.Pu.H_(i),await async function(e,t){const n=Vv(e);try{await n.persistence.runTransaction("notifyLocalViewChanges","readwrite",e=>Aw.forEach(t,t=>Aw.forEach(t.Ts,r=>n.persistence.referenceDelegate.addReference(e,t.targetId,r)).next(()=>Aw.forEach(t.Es,r=>n.persistence.referenceDelegate.removeReference(e,t.targetId,r)))))}catch(e){if(!Nw(e))throw e;Pv(Uk,"Failed to update sequence numbers: "+e)}for(const e of t){const t=e.targetId;if(!e.fromCache){const e=n.vs.get(t),r=e.snapshotVersion,i=e.withLastLimboFreeSnapshotVersion(r);n.vs=n.vs.insert(t,i)}}}(r.localStore,a))}async function OT(e,t){const n=Vv(e);if(!n.currentUser.isEqual(t)){Pv(hT,"User change. New user:",t.toKey());const e=await zk(n.localStore,t);n.currentUser=t,i="'waitForPendingWrites' promise is rejected due to a user change.",(r=n).mu.forEach(e=>{e.forEach(e=>{e.reject(new jv(zv.CANCELLED,i))})}),r.mu.clear(),n.sharedClientState.handleUserChange(t,e.removedBatchIds,e.addedBatchIds),await DT(n,e.Ns)}var r,i}function LT(e,t){const n=Vv(e),r=n.Au.get(t);if(r&&r.hu)return CE().add(r.key);{let e=CE();const r=n.Eu.get(t);if(!r)return e;for(const t of r){const r=n.Tu.get(t);e=e.unionWith(r.view.nu)}return e}}function MT(e){const t=Vv(e);return t.remoteStore.remoteSyncer.applyRemoteEvent=ET.bind(null,t),t.remoteStore.remoteSyncer.getRemoteKeysForTarget=LT.bind(null,t),t.remoteStore.remoteSyncer.rejectListen=kT.bind(null,t),t.Pu.H_=nT.bind(null,t.eventManager),t.Pu.yu=rT.bind(null,t.eventManager),t}class FT{constructor(){this.kind="memory",this.synchronizeTabs=!1}async initialize(e){this.serializer=oI(e.databaseInfo.databaseId),this.sharedClientState=this.Du(e),this.persistence=this.Cu(e),await this.persistence.start(),this.localStore=this.vu(e),this.gcScheduler=this.Fu(e,this.localStore),this.indexBackfillerScheduler=this.Mu(e,this.localStore)}Fu(e,t){return null}Mu(e,t){return null}vu(e){return function(e,t,n,r){return new Vk(e,t,n,r)}(this.persistence,new Fk,e.initialUser,this.serializer)}Cu(e){return new Rk(Dk.Vi,this.serializer)}Du(e){return new Kk}async terminate(){this.gcScheduler?.stop(),this.indexBackfillerScheduler?.stop(),this.sharedClientState.shutdown(),await this.persistence.shutdown()}}FT.provider={build:()=>new FT};class UT extends FT{constructor(e){super(),this.cacheSizeBytes=e}Fu(e,t){Uv(this.persistence.referenceDelegate instanceof Ok,46915);const n=this.persistence.referenceDelegate.garbageCollector;return new yk(n,e.asyncQueue,t)}Cu(e){const t=void 0!==this.cacheSizeBytes?dk.withCacheSize(this.cacheSizeBytes):dk.DEFAULT;return new Rk(e=>Ok.Vi(e,t),this.serializer)}}class VT{async initialize(e,t){this.localStore||(this.localStore=e.localStore,this.sharedClientState=e.sharedClientState,this.datastore=this.createDatastore(t),this.remoteStore=this.createRemoteStore(t),this.eventManager=this.createEventManager(t),this.syncEngine=this.createSyncEngine(t,!e.synchronizeTabs),this.sharedClientState.onlineStateHandler=e=>_T(this.syncEngine,e,1),this.remoteStore.remoteSyncer.handleCredentialChange=OT.bind(null,this.syncEngine),await async function(e,t){const n=Vv(e);t?(n.Ia.delete(2),await vI(n)):t||(n.Ia.add(2),await wI(n),n.Va.set("Unknown"))}(this.remoteStore,this.syncEngine.isPrimaryClient))}createEventManager(e){return new XI}createDatastore(e){const t=oI(e.databaseInfo.databaseId),n=function(e){return new aI(e)}(e.databaseInfo);return function(e,t,n,r){return new pI(e,t,n,r)}(e.authCredentials,e.appCheckCredentials,n,t)}createRemoteStore(e){return t=this.localStore,n=this.datastore,r=e.asyncQueue,i=e=>_T(this.syncEngine,e,0),a=Yk.v()?new Yk:new Gk,new yI(t,n,r,i,a);var t,n,r,i,a}createSyncEngine(e,t){return function(e,t,n,r,i,a,s){const o=new pT(e,t,n,r,i,a);return s&&(o.gu=!0),o}(this.localStore,this.remoteStore,this.eventManager,this.sharedClientState,e.initialUser,e.maxConcurrentLimboResolutions,t)}async terminate(){await async function(e){const t=Vv(e);Pv(gI,"RemoteStore shutting down."),t.Ia.add(5),await wI(t),t.Aa.shutdown(),t.Va.set("Unknown")}(this.remoteStore),this.datastore?.terminate(),this.eventManager?.terminate()}}VT.provider={build:()=>new VT};
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const jT="FirestoreClient";class BT{constructor(e,t,n,r,i){this.authCredentials=e,this.appCheckCredentials=t,this.asyncQueue=n,this._databaseInfo=r,this.user=Av.UNAUTHENTICATED,this.clientId=Xv.newId(),this.authCredentialListener=()=>Promise.resolve(),this.appCheckCredentialListener=()=>Promise.resolve(),this._uninitializedComponentsProvider=i,this.authCredentials.start(n,async e=>{Pv(jT,"Received user=",e.uid),await this.authCredentialListener(e),this.user=e}),this.appCheckCredentials.start(n,e=>(Pv(jT,"Received new app check token=",e),this.appCheckCredentialListener(e,this.user)))}get configuration(){return{asyncQueue:this.asyncQueue,databaseInfo:this._databaseInfo,clientId:this.clientId,authCredentials:this.authCredentials,appCheckCredentials:this.appCheckCredentials,initialUser:this.user,maxConcurrentLimboResolutions:100}}setCredentialChangeListener(e){this.authCredentialListener=e}setAppCheckTokenChangeListener(e){this.appCheckCredentialListener=e}terminate(){this.asyncQueue.enterRestrictedMode();const e=new Bv;return this.asyncQueue.enqueueAndForgetEvenWhileRestricted(async()=>{try{this._onlineComponents&&await this._onlineComponents.terminate(),this._offlineComponents&&await this._offlineComponents.terminate(),this.authCredentials.shutdown(),this.appCheckCredentials.shutdown(),e.resolve()}catch(t){const n=KI(t,"Failed to shutdown persistence");e.reject(n)}}),e.promise}}async function qT(e,t){e.asyncQueue.verifyOperationInProgress(),Pv(jT,"Initializing OfflineComponentProvider");const n=e.configuration;await t.initialize(n);let r=n.initialUser;e.setCredentialChangeListener(async e=>{r.isEqual(e)||(await zk(t.localStore,e),r=e)}),t.persistence.setDatabaseDeletedListener(()=>e.terminate()),e._offlineComponents=t}async function HT(e,t){e.asyncQueue.verifyOperationInProgress();const n=await async function(e){if(!e._offlineComponents)if(e._uninitializedComponentsProvider){Pv(jT,"Using user provided OfflineComponentProvider");try{await qT(e,e._uninitializedComponentsProvider._offline)}catch(n){const r=n;if(!("FirebaseError"===(t=r).name?t.code===zv.FAILED_PRECONDITION||t.code===zv.UNIMPLEMENTED:!("undefined"!=typeof DOMException&&t instanceof DOMException)||22===t.code||20===t.code||11===t.code))throw r;Ov("Error using user provided cache. Falling back to memory cache: "+r),await qT(e,new FT)}}else Pv(jT,"Using default OfflineComponentProvider"),await qT(e,new UT(void 0));var t;return e._offlineComponents}(e);Pv(jT,"Initializing OnlineComponentProvider"),await t.initialize(n,e.configuration),e.setCredentialChangeListener(e=>qI(t.remoteStore,e)),e.setAppCheckTokenChangeListener((e,n)=>qI(t.remoteStore,n)),e._onlineComponents=t}async function WT(e){return e._onlineComponents||(e._uninitializedComponentsProvider?(Pv(jT,"Using user provided OnlineComponentProvider"),await HT(e,e._uninitializedComponentsProvider._online)):(Pv(jT,"Using default OnlineComponentProvider"),await HT(e,new VT))),e._onlineComponents}async function $T(e){const t=await WT(e),n=t.eventManager;return n.onListen=mT.bind(null,t.syncEngine),n.onUnlisten=vT.bind(null,t.syncEngine),n.onFirstRemoteStoreListen=gT.bind(null,t.syncEngine),n.onLastRemoteStoreUnlisten=wT.bind(null,t.syncEngine),n}function KT(e,t){const n=new Bv;return e.asyncQueue.enqueueAndForget(async()=>bT(await function(e){return WT(e).then(e=>e.syncEngine)}(e),t,n)),n.promise
/**
 * @license
 * Copyright 2023 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e),e._firestoreClient}class hS{constructor(e){this._byteString=e}static fromBase64String(e){try{return new hS(Ww.fromBase64String(e))}catch(e){throw new jv(zv.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+e)}}static fromUint8Array(e){return new hS(Ww.fromUint8Array(e))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(e){return this._byteString.isEqual(e._byteString)}toJSON(){return{type:hS._jsonSchemaVersion,bytes:this.toBase64()}}static fromJSON(e){if(vw(e,hS._jsonSchema))return hS.fromBase64String(e.bytes)}}hS._jsonSchemaVersion="firestore/bytes/1.0",hS._jsonSchema={type:yw("string",hS._jsonSchemaVersion),bytes:yw("string")};
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
const gS=/^__.*__$/;class yS{constructor(e,t,n){this.data=e,this.fieldMask=t,this.fieldTransforms=n}toMutation(e,t){return null!==this.fieldMask?new t_(e,this.data,this.fieldMask,t,this.fieldTransforms):new e_(e,this.data,t,this.fieldTransforms)}}function vS(e){switch(e){case 0:case 2:case 1:return!0;case 3:case 4:return!1;default:throw Mv(40011,{dataSource:e})}}class wS{constructor(e,t,n,r,i,a){this.settings=e,this.databaseId=t,this.serializer=n,this.ignoreUndefinedProperties=r,void 0===i&&this.Ac(),this.fieldTransforms=i||[],this.fieldMask=a||[]}get path(){return this.settings.path}get dataSource(){return this.settings.dataSource}i(e){return new wS({...this.settings,...e},this.databaseId,this.serializer,this.ignoreUndefinedProperties,this.fieldTransforms,this.fieldMask)}dc(e){const t=this.path?.child(e),n=this.i({path:t,arrayElement:!1});return n.mc(e),n}fc(e){const t=this.path?.child(e),n=this.i({path:t,arrayElement:!1});return n.Ac(),n}gc(e){return this.i({path:void 0,arrayElement:!0})}yc(e){return xS(e,this.settings.methodName,this.settings.hasConverter||!1,this.path,this.settings.targetDoc)}contains(e){return void 0!==this.fieldMask.find(t=>e.isPrefixOf(t))||void 0!==this.fieldTransforms.find(t=>e.isPrefixOf(t.field))}Ac(){if(this.path)for(let e=0;e<this.path.length;e++)this.mc(this.path.get(e))}mc(e){if(0===e.length)throw this.yc("Document fields must not be empty");if(vS(this.dataSource)&&gS.test(e))throw this.yc('Document fields cannot begin and end with "__"')}}class bS{constructor(e,t,n){this.databaseId=e,this.ignoreUndefinedProperties=t,this.serializer=n||oI(e)}I(e,t,n,r=!1){return new wS({dataSource:e,methodName:t,targetDoc:n,path:cw.emptyPath(),arrayElement:!1,hasConverter:r},this.databaseId,this.serializer,this.ignoreUndefinedProperties)}}function ES(e){const t=e._freezeSettings(),n=oI(e._databaseId);return new bS(e._databaseId,!!t.ignoreUndefinedProperties,n)}function _S(e,t,n,r,i,a={}){const s=e.I(a.merge||a.mergeFields?2:0,t,n,i);CS("Data must be an object, but it was:",s,r);const o=TS(r,s);let l,c;if(a.merge)l=new qw(s.fieldMask),c=s.fieldTransforms;else if(a.mergeFields){const e=[];for(const r of a.mergeFields){const i=AS(t,r,n);if(!s.contains(i))throw new jv(zv.INVALID_ARGUMENT,`Field '${i}' is specified in your field mask but missing from your input data.`);RS(e,i)||e.push(i)}l=new qw(e),c=s.fieldTransforms.filter(e=>l.covers(e.field))}else l=null,c=s.fieldTransforms;return new yS(new Cb(o),l,c)}class kS extends fS{_toFieldTransform(e){return new HE(e.path,new ME)}isEqual(e){return e instanceof kS}}function IS(e,t){if(SS(e=vh(e)))return CS("Unsupported field value:",t,e),TS(e,t);if(e instanceof fS)return function(e,t){if(!vS(t.dataSource))throw t.yc(`${e._methodName}() can only be used with update() and set()`);if(!t.path)throw t.yc(`${e._methodName}() is not currently supported inside arrays`);const n=e._toFieldTransform(t);n&&t.fieldTransforms.push(n)}(e,t),null;if(void 0===e&&t.ignoreUndefinedProperties)return null;if(t.path&&t.fieldMask.push(t.path),e instanceof Array){if(t.settings.arrayElement&&4!==t.dataSource)throw t.yc("Nested arrays are not supported");return function(e,t){const n=[];let r=0;for(const i of e){let e=IS(i,t.gc(r));null==e&&(e={nullValue:"NULL_VALUE"}),n.push(e),r++}return{arrayValue:{values:n}}}(e,t)}return function(e,t){if(null===(e=vh(e)))return{nullValue:"NULL_VALUE"};if("number"==typeof e)return RE(t.serializer,e);if("boolean"==typeof e)return{booleanValue:e};if("string"==typeof e)return{stringValue:e};if(e instanceof Date){const n=Ew.fromDate(e);return{timestampValue:D_(t.serializer,n)}}if(e instanceof Ew){const n=new Ew(e.seconds,1e3*Math.floor(e.nanoseconds/1e3));return{timestampValue:D_(t.serializer,n)}}if(e instanceof pS)return{geoPointValue:{latitude:e.latitude,longitude:e.longitude}};if(e instanceof hS)return{bytesValue:O_(t.serializer,e._byteString)};if(e instanceof nS){const n=t.databaseId,r=e.firestore._databaseId;if(!r.isEqual(n))throw t.yc(`Document reference is for database ${r.projectId}/${r.database} but should be for database ${n.projectId}/${n.database}`);return{referenceValue:F_(e.firestore._databaseId||t.databaseId,e._key.path)}}if(e instanceof mS)return function(e,t){const n=e instanceof mS?e.toArray():e;return{mapValue:{fields:{[sb]:{stringValue:cb},[ub]:{arrayValue:{values:n.map(e=>{if("number"!=typeof e)throw t.yc("VectorValues must only contain numeric values.");return NE(t.serializer,e)})}}}}}}(e,t);if(ik(e))return e._toProto(t.serializer);throw t.yc(`Unsupported field value: ${mw(e)}`)}(e,t)}function TS(e,t){const n={};return Fw(e)?t.path&&t.path.length>0&&t.fieldMask.push(t.path):Mw(e,(e,r)=>{const i=IS(r,t.dc(e));null!=i&&(n[e]=i)}),{mapValue:{fields:n}}}function SS(e){return!("object"!=typeof e||null===e||e instanceof Array||e instanceof Date||e instanceof Ew||e instanceof pS||e instanceof hS||e instanceof nS||e instanceof fS||e instanceof mS||ik(e))}function CS(e,t,n){if(!SS(n)||!pw(n)){const r=mw(n);throw"an object"===r?t.yc(e+" a custom object"):t.yc(e+" "+r)}}function AS(e,t,n){if((t=vh(t))instanceof dS)return t._internalPath;if("string"==typeof t)return function(e,t,n){if(t.search(NS)>=0)throw xS(`Invalid field path (${t}). Paths must not contain '~', '*', '/', '[', or ']'`,e,!1,void 0,n);try{return new dS(...t.split("."))._internalPath}catch(r){throw xS(`Invalid field path (${t}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,e,!1,void 0,n)}}(e,t);throw xS("Field path arguments must be of type string or ",e,!1,void 0,n)}const NS=new RegExp("[~\\*/\\[\\]]");function xS(e,t,n,r,i){const a=r&&!r.isEmpty(),s=void 0!==i;let o=`Function ${t}() called with invalid data`;n&&(o+=" (via `toFirestore()`)"),o+=". ";let l="";return(a||s)&&(l+=" (found",a&&(l+=` in field ${r}`),s&&(l+=` in document ${i}`),l+=")"),new jv(zv.INVALID_ARGUMENT,o+e+l)}function RS(e,t){return e.some(e=>e.isEqual(t))}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class DS extends PS{constructor(e){super(),this.firestore=e}convertBytes(e){return new hS(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new nS(this.firestore,null,t)}}function OS(){return new kS("serverTimestamp")}const LS="@firebase/firestore",MS="4.14.0";
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
const EC=/^[cdef][\w-]{21}$/;function _C(){try{const e=new Uint8Array(17);(self.crypto||self.msCrypto).getRandomValues(e),e[0]=112+e[0]%16;const t=function(e){const t=(n=e,btoa(String.fromCharCode(...n)).replace(/\+/g,"-").replace(/\//g,"_"));var n;return t.substr(0,22)}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e);return EC.test(t)?t:""}catch{return""}}function kC(e){return`${e.appName}!${e.appId}`}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
const AC="firebase-installations-store";let NC=null;function xC(){return NC||(NC=Hh("firebase-installations-database",1,{upgrade:(e,t)=>{if(0===t)e.createObjectStore(AC)}})),NC}async function RC(e,t){const n=kC(e),r=(await xC()).transaction(AC,"readwrite"),i=r.objectStore(AC),a=await i.get(n);return await i.put(t,n),await r.done,a&&a.fid===t.fid||TC(e,t.fid),t}async function PC(e){const t=kC(e),n=(await xC()).transaction(AC,"readwrite");await n.objectStore(AC).delete(t),await n.done}async function DC(e,t){const n=kC(e),r=(await xC()).transaction(AC,"readwrite"),i=r.objectStore(AC),a=await i.get(n),s=t(a);return void 0===s?await i.delete(n):await i.put(s,n),await r.done,!s||a&&a.fid===s.fid||TC(e,s.fid),s}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function OC(e){let t;const n=await DC(e.appConfig,n=>{const r=function(e){const t=e||{fid:_C(),registrationStatus:0};return FC(t)}(n),i=function(e,t){if(0===t.registrationStatus){if(!navigator.onLine){return{installationEntry:t,registrationPromise:Promise.reject(dC.create("app-offline"))}}const n={fid:t.fid,registrationStatus:1,registrationTime:Date.now()},r=async function(e,t){try{const n=await async function({appConfig:e,heartbeatServiceProvider:t},{fid:n}){const r=pC(e),i=yC(e),a=t.getImmediate({optional:!0});if(a){const e=await a.getHeartbeatsHeader();e&&i.append("x-firebase-client",e)}const s={fid:n,authVersion:uC,appId:e.appId,sdkVersion:cC},o={method:"POST",headers:i,body:JSON.stringify(s)},l=await wC(()=>fetch(r,o));if(l.ok){const e=await l.json();return{fid:e.fid||n,registrationStatus:2,refreshToken:e.refreshToken,authToken:mC(e.authToken)}}throw await gC("Create Installation",l)}(e,t);return RC(e.appConfig,n)}catch(n){throw fC(n)&&409===n.customData.serverCode?await PC(e.appConfig):await RC(e.appConfig,{fid:t.fid,registrationStatus:0}),n}}(e,n);return{installationEntry:n,registrationPromise:r}}return 1===t.registrationStatus?{installationEntry:t,registrationPromise:LC(e)}:{installationEntry:t}}(e,r);return t=i.registrationPromise,i.installationEntry});return""===n.fid?{installationEntry:await t}:{installationEntry:n,registrationPromise:t}}async function LC(e){let t=await MC(e.appConfig);for(;1===t.registrationStatus;)await bC(100),t=await MC(e.appConfig);if(0===t.registrationStatus){const{installationEntry:t,registrationPromise:n}=await OC(e);return n||t}return t}function MC(e){return DC(e,e=>{if(!e)throw dC.create("installation-not-found");return FC(e)})}function FC(e){return 1===(t=e).registrationStatus&&t.registrationTime+lC<Date.now()?{fid:e.fid,registrationStatus:0}:e;var t;
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(n);return(await VC(n,t)).token}function qC(e){return dC.create("missing-app-config-values",{valueName:e})}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const HC="installations",WC=e=>{const t=Pd(e.getProvider("app").getImmediate(),HC).getImmediate();return{getId:()=>async function(e){const t=e,{installationEntry:n,registrationPromise:r}=await OC(t);return r?r.catch(console.error):VC(t).catch(console.error),n.fid}(t),getToken:e=>BC(t,e)}};Rd(new Eh(HC,e=>{const t=e.getProvider("app").getImmediate(),n=function(e){if(!e||!e.options)throw qC("App Configuration");if(!e.name)throw qC("App Name");const t=["projectId","apiKey","appId"];for(const n of t)if(!e.options[n])throw qC(n);return{appName:e.name,projectId:e.options.projectId,apiKey:e.options.apiKey,appId:e.options.appId}}(t);return{app:t,appConfig:n,heartbeatServiceProvider:Pd(t,"heartbeat"),_delete:()=>Promise.resolve()}},"PUBLIC")),Rd(new Eh("installations-internal",WC,"PRIVATE")),Vd(sC,oC),Vd(sC,oC,"esm2020");
/**
 * @license
 * Copyright 2019 Google LLC
 *
